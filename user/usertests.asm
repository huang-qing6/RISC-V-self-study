...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	bd250513          	addi	a0,a0,-1070 # 5c10 <statistics+0x388>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	07078793          	addi	a5,a5,112 # 90c8 <uninit>
      60:	0000b697          	auipc	a3,0xb
      64:	77868693          	addi	a3,a3,1912 # b7d8 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	bb050513          	addi	a0,a0,-1104 # 5c30 <statistics+0x3a8>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	ba050513          	addi	a0,a0,-1120 # 5c48 <statistics+0x3c0>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	ba250513          	addi	a0,a0,-1118 # 5c68 <statistics+0x3e0>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	b6a50513          	addi	a0,a0,-1174 # 5c50 <statistics+0x3c8>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	b7650513          	addi	a0,a0,-1162 # 5c78 <statistics+0x3f0>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	b7450513          	addi	a0,a0,-1164 # 5ca0 <statistics+0x418>
     134:	00005097          	auipc	ra,0x5
     138:	28a080e7          	jalr	650(ra) # 53be <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	b6050513          	addi	a0,a0,-1184 # 5ca0 <statistics+0x418>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	b5c58593          	addi	a1,a1,-1188 # 5cb0 <statistics+0x428>
     15c:	00005097          	auipc	ra,0x5
     160:	232080e7          	jalr	562(ra) # 538e <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	b3850513          	addi	a0,a0,-1224 # 5ca0 <statistics+0x418>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	b3c58593          	addi	a1,a1,-1220 # 5cb8 <statistics+0x430>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	b0c50513          	addi	a0,a0,-1268 # 5ca0 <statistics+0x418>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	af650513          	addi	a0,a0,-1290 # 5cc0 <statistics+0x438>
...
00000000000001e4 <createtest>:
{
  ...
  name[0] = 'a';
     ...
     1f6:	dbe78793          	addi	a5,a5,-578 # 7fb0 <name>
  ...
  name[0] = 'a';
     ...
     238:	d7c78793          	addi	a5,a5,-644 # 7fb0 <name>
...
0000000000000278 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     294:	83050513          	addi	a0,a0,-2000 # 5ac0 <statistics+0x238>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2a8:	81ca8a93          	addi	s5,s5,-2020 # 5ac0 <statistics+0x238>
      int cc = write(fd, buf, sz);
     2ac:	0000ba17          	auipc	s4,0xb
     2b0:	52ca0a13          	addi	s4,s4,1324 # b7d8 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2b4:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     32a:	9c250513          	addi	a0,a0,-1598 # 5ce8 <statistics+0x460>
     ...
     34e:	9be50513          	addi	a0,a0,-1602 # 5d08 <statistics+0x480>
...
0000000000000364 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     38a:	99aa0a13          	addi	s4,s4,-1638 # 5d20 <statistics+0x498>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     436:	8f650513          	addi	a0,a0,-1802 # 5d28 <statistics+0x4a0>
     ...
     454:	8f050513          	addi	a0,a0,-1808 # 5d40 <statistics+0x4b8>
     ...
     472:	90250513          	addi	a0,a0,-1790 # 5d70 <statistics+0x4e8>
     ...
     48c:	91850513          	addi	a0,a0,-1768 # 5da0 <statistics+0x518>
     ...
     4aa:	90a50513          	addi	a0,a0,-1782 # 5db0 <statistics+0x528>
...
00000000000004c0 <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4e8:	8fca0a13          	addi	s4,s4,-1796 # 5de0 <statistics+0x558>
    n = write(fds[1], "x", 1);
     4ec:	00005a97          	auipc	s5,0x5
     4f0:	7cca8a93          	addi	s5,s5,1996 # 5cb8 <statistics+0x430>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     596:	85650513          	addi	a0,a0,-1962 # 5de8 <statistics+0x560>
     ...
     5b4:	85050513          	addi	a0,a0,-1968 # 5e00 <statistics+0x578>
     ...
     5ce:	7d650513          	addi	a0,a0,2006 # 5da0 <statistics+0x518>
     ...
     5e8:	84c50513          	addi	a0,a0,-1972 # 5e30 <statistics+0x5a8>
     ...
     606:	84650513          	addi	a0,a0,-1978 # 5e48 <statistics+0x5c0>
...
000000000000061c <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     65c:	65858593          	addi	a1,a1,1624 # 5cb0 <statistics+0x428>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     678:	62c50513          	addi	a0,a0,1580 # 5ca0 <statistics+0x418>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     6a4:	60050513          	addi	a0,a0,1536 # 5ca0 <statistics+0x418>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6b8:	5ec50513          	addi	a0,a0,1516 # 5ca0 <statistics+0x418>
  ...
  write(fd1, "abcdef", 6);
     ...
     6f6:	7e658593          	addi	a1,a1,2022 # 5ed8 <statistics+0x650>
     6fa:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     738:	56c50513          	addi	a0,a0,1388 # 5ca0 <statistics+0x418>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     77c:	70050513          	addi	a0,a0,1792 # 5e78 <statistics+0x5f0>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     798:	70450513          	addi	a0,a0,1796 # 5e98 <statistics+0x610>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7ac:	70050513          	addi	a0,a0,1792 # 5ea8 <statistics+0x620>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7c8:	70450513          	addi	a0,a0,1796 # 5ec8 <statistics+0x640>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7dc:	6d050513          	addi	a0,a0,1744 # 5ea8 <statistics+0x620>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7fa:	6ea50513          	addi	a0,a0,1770 # 5ee0 <statistics+0x658>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     818:	6ec50513          	addi	a0,a0,1772 # 5f00 <statistics+0x678>
...
000000000000082e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     84c:	6d850513          	addi	a0,a0,1752 # 5f20 <statistics+0x698>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     864:	6e898993          	addi	s3,s3,1768 # 5f48 <statistics+0x6c0>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     868:	00005a97          	auipc	s5,0x5
     86c:	718a8a93          	addi	s5,s5,1816 # 5f80 <statistics+0x6f8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8b2:	67250513          	addi	a0,a0,1650 # 5f20 <statistics+0x698>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8cc:	f1058593          	addi	a1,a1,-240 # b7d8 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8ee:	63650513          	addi	a0,a0,1590 # 5f20 <statistics+0x698>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     918:	61450513          	addi	a0,a0,1556 # 5f28 <statistics+0x6a0>
    ...
    exit(1);
     ...
     934:	62850513          	addi	a0,a0,1576 # 5f58 <statistics+0x6d0>
     ...
     950:	64450513          	addi	a0,a0,1604 # 5f90 <statistics+0x708>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     96c:	65050513          	addi	a0,a0,1616 # 5fb8 <statistics+0x730>
    ...
    printf("%s: read failed\n", s);
     ...
     988:	65450513          	addi	a0,a0,1620 # 5fd8 <statistics+0x750>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9a4:	65050513          	addi	a0,a0,1616 # 5ff0 <statistics+0x768>
...
00000000000009ba <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9d6:	63e50513          	addi	a0,a0,1598 # 6010 <statistics+0x788>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9ea:	df290913          	addi	s2,s2,-526 # b7d8 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a28:	5ec50513          	addi	a0,a0,1516 # 6010 <statistics+0x788>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a3c:	da090913          	addi	s2,s2,-608 # b7d8 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a70:	5ac50513          	addi	a0,a0,1452 # 6018 <statistics+0x790>
    ...
    exit(1);
     ...
     a8c:	5b050513          	addi	a0,a0,1456 # 6038 <statistics+0x7b0>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     aa8:	5bc50513          	addi	a0,a0,1468 # 6060 <statistics+0x7d8>
  ...
  if(unlink("big") < 0){
     ...
     ad4:	54050513          	addi	a0,a0,1344 # 6010 <statistics+0x788>
     ...
     afe:	58650513          	addi	a0,a0,1414 # 6080 <statistics+0x7f8>
     ...
     b1a:	59250513          	addi	a0,a0,1426 # 60a8 <statistics+0x820>
     ...
     b36:	58e50513          	addi	a0,a0,1422 # 60c0 <statistics+0x838>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b52:	59a50513          	addi	a0,a0,1434 # 60e8 <statistics+0x860>
...
0000000000000b68 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b80:	edc50513          	addi	a0,a0,-292 # 5a58 <statistics+0x1d0>
  ...
  write(fd, "hello", SZ);
     ...
     b98:	58c58593          	addi	a1,a1,1420 # 6120 <statistics+0x898>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb4:	ea850513          	addi	a0,a0,-344 # 5a58 <statistics+0x1d0>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bca:	e9250513          	addi	a0,a0,-366 # 5a58 <statistics+0x1d0>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     be0:	e7c50513          	addi	a0,a0,-388 # 5a58 <statistics+0x1d0>
  ...
  write(fd1, "yyy", 3);
     ...
     bf4:	57858593          	addi	a1,a1,1400 # 6168 <statistics+0x8e0>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c10:	bcc58593          	addi	a1,a1,-1076 # b7d8 <buf>
     c14:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c5c:	e0050513          	addi	a0,a0,-512 # 5a58 <statistics+0x1d0>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c7c:	48850513          	addi	a0,a0,1160 # 6100 <statistics+0x878>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c98:	49450513          	addi	a0,a0,1172 # 6128 <statistics+0x8a0>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cb4:	49850513          	addi	a0,a0,1176 # 6148 <statistics+0x8c0>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cd0:	4a450513          	addi	a0,a0,1188 # 6170 <statistics+0x8e8>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     cec:	4a850513          	addi	a0,a0,1192 # 6190 <statistics+0x908>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d08:	4ac50513          	addi	a0,a0,1196 # 61b0 <statistics+0x928>
...
0000000000000d1e <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d6c:	3b858593          	addi	a1,a1,952 # 6120 <statistics+0x898>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d8c:	45058593          	addi	a1,a1,1104 # 61d8 <statistics+0x950>
     d90:	00005517          	auipc	a0,0x5
     d94:	44050513          	addi	a0,a0,1088 # 61d0 <statistics+0x948>
  ...
  unlink("lf1");
     ...
     da8:	42c50513          	addi	a0,a0,1068 # 61d0 <statistics+0x948>
     dac:	00004097          	auipc	ra,0x4
     db0:	612080e7          	jalr	1554(ra) # 53be <unlink>
  if(open("lf1", 0) >= 0){
     db4:	4581                	li	a1,0
     db6:	00005517          	auipc	a0,0x5
     dba:	41a50513          	addi	a0,a0,1050 # 61d0 <statistics+0x948>
  ...
  fd = open("lf2", 0);
     ...
     dd0:	40c50513          	addi	a0,a0,1036 # 61d8 <statistics+0x950>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de8:	9f458593          	addi	a1,a1,-1548 # b7d8 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e08:	3d458593          	addi	a1,a1,980 # 61d8 <statistics+0x950>
     e0c:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e1e:	3be50513          	addi	a0,a0,958 # 61d8 <statistics+0x950>
     e22:	00004097          	auipc	ra,0x4
     e26:	59c080e7          	jalr	1436(ra) # 53be <unlink>
  if(link("lf2", "lf1") >= 0){
     e2a:	00005597          	auipc	a1,0x5
     e2e:	3a658593          	addi	a1,a1,934 # 61d0 <statistics+0x948>
     e32:	00005517          	auipc	a0,0x5
     e36:	3a650513          	addi	a0,a0,934 # 61d8 <statistics+0x950>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e4a:	38a58593          	addi	a1,a1,906 # 61d0 <statistics+0x948>
     e4e:	00005517          	auipc	a0,0x5
     e52:	49250513          	addi	a0,a0,1170 # 62e0 <statistics+0xa58>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e74:	37050513          	addi	a0,a0,880 # 61e0 <statistics+0x958>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e90:	36c50513          	addi	a0,a0,876 # 61f8 <statistics+0x970>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     eac:	36850513          	addi	a0,a0,872 # 6210 <statistics+0x988>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec8:	36c50513          	addi	a0,a0,876 # 6230 <statistics+0x9a8>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     ee4:	38050513          	addi	a0,a0,896 # 6260 <statistics+0x9d8>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     f00:	37c50513          	addi	a0,a0,892 # 6278 <statistics+0x9f0>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f1c:	37850513          	addi	a0,a0,888 # 6290 <statistics+0xa08>
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f38:	38450513          	addi	a0,a0,900 # 62b8 <statistics+0xa30>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f54:	39850513          	addi	a0,a0,920 # 62e8 <statistics+0xa60>
...
0000000000000f6a <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fba:	352a0a13          	addi	s4,s4,850 # 6308 <statistics+0xa80>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    100c:	30050513          	addi	a0,a0,768 # 6308 <statistics+0xa80>
  ...
  for(i = 0; i < N; i++){
    ...
    107c:	29850513          	addi	a0,a0,664 # 6310 <statistics+0xa88>
    ...
    109c:	29850513          	addi	a0,a0,664 # 6330 <statistics+0xaa8>
    ...
    10b8:	29c50513          	addi	a0,a0,668 # 6350 <statistics+0xac8>
...
00000000000010ce <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10ea:	28a98993          	addi	s3,s3,650 # 6370 <statistics+0xae8>
    10ee:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1126:	25e50513          	addi	a0,a0,606 # 6380 <statistics+0xaf8>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    114e:	e564b483          	ld	s1,-426(s1) # 7fa0 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    1184:	35048493          	addi	s1,s1,848 # c350 <buf+0xb78>
  for(int i = 0; i < 50000; i++){
    ...
    1192:	aba98993          	addi	s3,s3,-1350 # 5c48 <statistics+0x3c0>
    argv[0] = (char*)0xffffffff;
...
00000000000011ba <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121c:	22878793          	addi	a5,a5,552 # 7440 <statistics+0x1bb8>
  ...
  if(pid == 0){
    ...
    1252:	e7278793          	addi	a5,a5,-398 # 80c0 <big.0>
    1256:	00008697          	auipc	a3,0x8
    125a:	e6a68693          	addi	a3,a3,-406 # 90c0 <__global_pointer$+0x920>
      big[i] = 'x';
    ...
    1270:	e4078a23          	sb	zero,-428(a5) # 90c0 <__global_pointer$+0x920>
    char *args2[] = { big, big, big, 0 };
    1274:	00007797          	auipc	a5,0x7
    1278:	94478793          	addi	a5,a5,-1724 # 7bb8 <statistics+0x2330>
    ...
    129c:	9b050513          	addi	a0,a0,-1616 # 5c48 <statistics+0x3c0>
    ...
    12b4:	17850513          	addi	a0,a0,376 # 6428 <statistics+0xba0>
    ...
    12d4:	0d050513          	addi	a0,a0,208 # 63a0 <statistics+0xb18>
    ...
    12f4:	0d050513          	addi	a0,a0,208 # 63c0 <statistics+0xb38>
    ...
    1316:	0ce50513          	addi	a0,a0,206 # 63e0 <statistics+0xb58>
    ...
    1336:	0d650513          	addi	a0,a0,214 # 6408 <statistics+0xb80>
    ...
    1350:	52450513          	addi	a0,a0,1316 # 6870 <statistics+0xfe8>
  ...
  if(st != 747){
    ...
    139a:	0ba50513          	addi	a0,a0,186 # 6450 <statistics+0xbc8>
...
00000000000013b0 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13cc:	8d850513          	addi	a0,a0,-1832 # 5ca0 <statistics+0x418>
  ...
  if(pid == 0){
    ...
    13f6:	8aea0a13          	addi	s4,s4,-1874 # 5ca0 <statistics+0x418>
      int n = write(fd, "1234567890", 10);
    13fa:	00005a97          	auipc	s5,0x5
    13fe:	0b6a8a93          	addi	s5,s5,182 # 64b0 <statistics+0xc28>
      int fd = open("truncfile", O_WRONLY);
    1402:	4585                	li	a1,1
    1404:	8552                	mv	a0,s4
    ...
    146e:	01650513          	addi	a0,a0,22 # 6480 <statistics+0xbf8>
    ...
    148a:	01250513          	addi	a0,a0,18 # 6498 <statistics+0xc10>
    ...
    14a8:	01c50513          	addi	a0,a0,28 # 64c0 <statistics+0xc38>
    ...
    14c6:	7dea0a13          	addi	s4,s4,2014 # 5ca0 <statistics+0x418>
    int n = write(fd, "xxx", 3);
    14ca:	00005a97          	auipc	s5,0x5
    14ce:	016a8a93          	addi	s5,s5,22 # 64e0 <statistics+0xc58>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1518:	78c50513          	addi	a0,a0,1932 # 5ca0 <statistics+0x418>
  ...
  exit(xstatus);
    ...
    1536:	f6650513          	addi	a0,a0,-154 # 6498 <statistics+0xc10>
    ...
    1554:	f9850513          	addi	a0,a0,-104 # 64e8 <statistics+0xc60>
...
000000000000156a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    157c:	6d078793          	addi	a5,a5,1744 # 5c48 <statistics+0x3c0>
    1580:	fcf43023          	sd	a5,-64(s0)
    1584:	00005797          	auipc	a5,0x5
    1588:	f8478793          	addi	a5,a5,-124 # 6508 <statistics+0xc80>
    158c:	fcf43423          	sd	a5,-56(s0)
    1590:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1594:	00005517          	auipc	a0,0x5
    1598:	f7c50513          	addi	a0,a0,-132 # 6510 <statistics+0xc88>
  ...
  if(pid == 0) {
    ...
    15c6:	f4e50513          	addi	a0,a0,-178 # 6510 <statistics+0xc88>
    ...
    15e2:	f5250513          	addi	a0,a0,-174 # 6530 <statistics+0xca8>
    ...
    15fe:	e8650513          	addi	a0,a0,-378 # 6480 <statistics+0xbf8>
    ...
    161a:	f0250513          	addi	a0,a0,-254 # 6518 <statistics+0xc90>
    ...
    1638:	61450513          	addi	a0,a0,1556 # 5c48 <statistics+0x3c0>
  ...
  if(xstatus != 0)
    ...
    166c:	ed850513          	addi	a0,a0,-296 # 6540 <statistics+0xcb8>
    ...
    1688:	ed450513          	addi	a0,a0,-300 # 6558 <statistics+0xcd0>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    169c:	e7850513          	addi	a0,a0,-392 # 6510 <statistics+0xc88>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16c6:	91650513          	addi	a0,a0,-1770 # 5fd8 <statistics+0x750>
    ...
    16e2:	dba50513          	addi	a0,a0,-582 # 6498 <statistics+0xc10>
  ...
  unlink("echo-ok");
    ...
    16fc:	e1850513          	addi	a0,a0,-488 # 6510 <statistics+0xc88>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1726:	e4e50513          	addi	a0,a0,-434 # 6570 <statistics+0xce8>
...
0000000000001746 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1792:	04aa8a93          	addi	s5,s5,74 # b7d8 <buf>
      if(cc > sizeof(buf))
    ...
    17b0:	02c70713          	addi	a4,a4,44 # b7d8 <buf>
    ...
    17e8:	da450513          	addi	a0,a0,-604 # 6588 <statistics+0xd00>
    ...
    180e:	fceb0b13          	addi	s6,s6,-50 # b7d8 <buf>
    ...
    1822:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x7d>
{
    ...
    186e:	d3650513          	addi	a0,a0,-714 # 65a0 <statistics+0xd18>
    ...
    188a:	d3250513          	addi	a0,a0,-718 # 65b8 <statistics+0xd30>
    ...
    18bc:	d1850513          	addi	a0,a0,-744 # 65d0 <statistics+0xd48>
    ...
    18fc:	cf850513          	addi	a0,a0,-776 # 65f0 <statistics+0xd68>
...
0000000000001912 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    196e:	b1650513          	addi	a0,a0,-1258 # 6480 <statistics+0xbf8>
    ...
    198a:	c8250513          	addi	a0,a0,-894 # 6608 <statistics+0xd80>
    ...
    19a6:	c7e50513          	addi	a0,a0,-898 # 6620 <statistics+0xd98>
...
00000000000019c6 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a1e:	a6650513          	addi	a0,a0,-1434 # 6480 <statistics+0xbf8>
    ...
    1a42:	a4250513          	addi	a0,a0,-1470 # 6480 <statistics+0xbf8>
...
0000000000001a60 <forkfork>:
{
    ...
    1abc:	b8850513          	addi	a0,a0,-1144 # 6640 <statistics+0xdb8>
    ...
    1ace:	8a4080e7          	jalr	-1884(ra) # 536e <exit>
{
    ...
    1b14:	b4050513          	addi	a0,a0,-1216 # 6650 <statistics+0xdc8>
...
0000000000001b2a <reparent2>:
{
  ...
  exit(0);
    ...
    1b62:	d1250513          	addi	a0,a0,-750 # 6870 <statistics+0xfe8>
...
0000000000001b92 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c00:	c7450513          	addi	a0,a0,-908 # 6870 <statistics+0xfe8>
    ...
    1c2c:	8f050513          	addi	a0,a0,-1808 # 6518 <statistics+0xc90>
    ...
    1c9e:	9d650513          	addi	a0,a0,-1578 # 6670 <statistics+0xde8>
    ...
    1cd2:	9ba50513          	addi	a0,a0,-1606 # 6688 <statistics+0xe00>
    ...
    1d38:	97c50513          	addi	a0,a0,-1668 # 66b0 <statistics+0xe28>
...
0000000000001db8 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd8:	ee450513          	addi	a0,a0,-284 # 5cb8 <statistics+0x430>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e14:	ea8a8a93          	addi	s5,s5,-344 # 5cb8 <statistics+0x430>
      link("cat", "x");
    1e18:	00005b97          	auipc	s7,0x5
    1e1c:	8c0b8b93          	addi	s7,s7,-1856 # 66d8 <statistics+0xe50>
    1e20:	a825                	j	1e58 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e22:	85a6                	mv	a1,s1
    1e24:	00004517          	auipc	a0,0x4
    1e28:	65c50513          	addi	a0,a0,1628 # 6480 <statistics+0xbf8>
...
0000000000001eba <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1eea:	81250513          	addi	a0,a0,-2030 # 66f8 <statistics+0xe70>
  ...
  if(wait(0) != -1){
    ...
    1f4c:	79850513          	addi	a0,a0,1944 # 66e0 <statistics+0xe58>
    ...
    1f68:	7bc50513          	addi	a0,a0,1980 # 6720 <statistics+0xe98>
    ...
    1f84:	7b850513          	addi	a0,a0,1976 # 6738 <statistics+0xeb0>
...
0000000000001f9a <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1fb6:	35098993          	addi	s3,s3,848 # c350 <buf+0xb78>
    1fba:	1003d937          	lui	s2,0x1003d
    1fbe:	090e                	slli	s2,s2,0x3
    1fc0:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002ec98>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2004:	48050513          	addi	a0,a0,1152 # 6480 <statistics+0xbf8>
    ...
    2024:	73050513          	addi	a0,a0,1840 # 6750 <statistics+0xec8>
...
0000000000002044 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2054:	72050513          	addi	a0,a0,1824 # 6770 <statistics+0xee8>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2086:	6ee50513          	addi	a0,a0,1774 # 6770 <statistics+0xee8>
  ...
  close(fd);
    ...
    20ac:	f1878793          	addi	a5,a5,-232 # 7fc0 <args.1>
    20b0:	00006697          	auipc	a3,0x6
    20b4:	00868693          	addi	a3,a3,8 # 80b8 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    20b8:	00004717          	auipc	a4,0x4
    20bc:	6c870713          	addi	a4,a4,1736 # 6780 <statistics+0xef8>
    ...
    2110:	75450513          	addi	a0,a0,1876 # 6860 <statistics+0xfd8>
    ...
    2134:	75050513          	addi	a0,a0,1872 # 6880 <statistics+0xff8>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2188:	0007c583          	lbu	a1,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0818>
    218c:	00004517          	auipc	a0,0x4
    2190:	71450513          	addi	a0,a0,1812 # 68a0 <statistics+0x1018>
    ...
    21ac:	2d850513          	addi	a0,a0,728 # 6480 <statistics+0xbf8>
...
00000000000021cc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2246:	1fe78793          	addi	a5,a5,510 # 7440 <statistics+0x1bb8>
  ...
  if(ret != -1){
    ...
    2288:	64450513          	addi	a0,a0,1604 # 68c8 <statistics+0x1040>
    ...
    22a6:	0fe50513          	addi	a0,a0,254 # 63a0 <statistics+0xb18>
    ...
    22c4:	10050513          	addi	a0,a0,256 # 63c0 <statistics+0xb38>
    ...
    22e4:	10050513          	addi	a0,a0,256 # 63e0 <statistics+0xb58>
    ...
    2302:	10a50513          	addi	a0,a0,266 # 6408 <statistics+0xb80>
...
0000000000002318 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2354:	6705                	lui	a4,0x1
      *b = 99;
    2356:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1818>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    236e:	56650513          	addi	a0,a0,1382 # 68d0 <statistics+0x1048>
  ...
  for(i = 0; i < 5000; i++){
    ...
    23c0:	53450513          	addi	a0,a0,1332 # 68f0 <statistics+0x1068>
  ...
  if(c != a + 1){
    ...
    2424:	53050513          	addi	a0,a0,1328 # 6950 <statistics+0x10c8>
    ...
    2444:	4d050513          	addi	a0,a0,1232 # 6910 <statistics+0x1088>
    ...
    2460:	4d450513          	addi	a0,a0,1236 # 6930 <statistics+0x10a8>
...
000000000000249c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    24fe:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1817>
  a = sbrk(0);
    2502:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2562:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1817>
  ...
  if(c != a){
    ...
    25aa:	3ca50513          	addi	a0,a0,970 # 6970 <statistics+0x10e8>
    ...
    25c6:	3f650513          	addi	a0,a0,1014 # 69b8 <statistics+0x1130>
    ...
    25e4:	3f850513          	addi	a0,a0,1016 # 69d8 <statistics+0x1150>
    ...
    2602:	41a50513          	addi	a0,a0,1050 # 6a18 <statistics+0x1190>
    ...
    261e:	42e50513          	addi	a0,a0,1070 # 6a48 <statistics+0x11c0>
    ...
    263c:	44850513          	addi	a0,a0,1096 # 6a80 <statistics+0x11f8>
...
0000000000002652 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2676:	43650513          	addi	a0,a0,1078 # 6aa8 <statistics+0x1220>
    267a:	00003097          	auipc	ra,0x3
    267e:	d34080e7          	jalr	-716(ra) # 53ae <open>
    2682:	84aa                	mv	s1,a0
  unlink("sbrk");
    2684:	00004517          	auipc	a0,0x4
    2688:	42450513          	addi	a0,a0,1060 # 6aa8 <statistics+0x1220>
  ...
  if(pipe((int *) a) != 0){
    ...
    26dc:	3d850513          	addi	a0,a0,984 # 6ab0 <statistics+0x1228>
    ...
    26f8:	3d450513          	addi	a0,a0,980 # 6ac8 <statistics+0x1240>
    ...
    2714:	e7850513          	addi	a0,a0,-392 # 6588 <statistics+0xd00>
...
000000000000272a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    273e:	3a650513          	addi	a0,a0,934 # 6ae0 <statistics+0x1258>
  ...
  close(fd);
    ...
    2786:	d1650513          	addi	a0,a0,-746 # 6498 <statistics+0xc10>
...
000000000000279c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    27d4:	0a050513          	addi	a0,a0,160 # 6870 <statistics+0xfe8>
  ...
  if(pid == 0){
    ...
    282a:	04a50513          	addi	a0,a0,74 # 6870 <statistics+0xfe8>
  ...
  if(pid == 0){
    ...
    288a:	fea50513          	addi	a0,a0,-22 # 6870 <statistics+0xfe8>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    28f6:	f7e50513          	addi	a0,a0,-130 # 6870 <statistics+0xfe8>
    ...
    294a:	30250513          	addi	a0,a0,770 # 5c48 <statistics+0x3c0>
    294e:	faa43c23          	sd	a0,-72(s0)
    2952:	00003797          	auipc	a5,0x3
    2956:	36678793          	addi	a5,a5,870 # 5cb8 <statistics+0x430>
...
0000000000002978 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2988:	33450513          	addi	a0,a0,820 # 6cb8 <statistics+0x1430>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    299a:	17a50513          	addi	a0,a0,378 # 6b10 <statistics+0x1288>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29b0:	1bc50513          	addi	a0,a0,444 # 6b68 <statistics+0x12e0>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    29ce:	21650513          	addi	a0,a0,534 # 6be0 <statistics+0x1358>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    29ea:	26a50513          	addi	a0,a0,618 # 6c50 <statistics+0x13c8>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    29fc:	2b050513          	addi	a0,a0,688 # 6ca8 <statistics+0x1420>
  ...
  unlink("12345678901234");
    ...
    2a7a:	07250513          	addi	a0,a0,114 # 6ae8 <statistics+0x1260>
    ...
    2a96:	09e50513          	addi	a0,a0,158 # 6b30 <statistics+0x12a8>
    ...
    2ab2:	0ea50513          	addi	a0,a0,234 # 6b98 <statistics+0x1310>
    ...
    2ace:	14650513          	addi	a0,a0,326 # 6c10 <statistics+0x1388>
    ...
    2aea:	18a50513          	addi	a0,a0,394 # 6c70 <statistics+0x13e8>
    ...
    2b06:	1c650513          	addi	a0,a0,454 # 6cc8 <statistics+0x1440>
...
0000000000002b1c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2b2c:	1d850513          	addi	a0,a0,472 # 6d00 <statistics+0x1478>
  ...
  if(chdir("iputdir") < 0){
    ...
    2b40:	1c450513          	addi	a0,a0,452 # 6d00 <statistics+0x1478>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2b54:	1f050513          	addi	a0,a0,496 # 6d40 <statistics+0x14b8>
  ...
  if(chdir("/") < 0){
    ...
    2b68:	20c50513          	addi	a0,a0,524 # 6d70 <statistics+0x14e8>
    ...
    2b88:	18450513          	addi	a0,a0,388 # 6d08 <statistics+0x1480>
    ...
    2ba4:	18050513          	addi	a0,a0,384 # 6d20 <statistics+0x1498>
    ...
    2bc0:	19450513          	addi	a0,a0,404 # 6d50 <statistics+0x14c8>
    ...
    2bdc:	1a050513          	addi	a0,a0,416 # 6d78 <statistics+0x14f0>
...
0000000000002bf2 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2c10:	0f450513          	addi	a0,a0,244 # 6d00 <statistics+0x1478>
    ...
    2c24:	0e050513          	addi	a0,a0,224 # 6d00 <statistics+0x1478>
    ...
    2c38:	10c50513          	addi	a0,a0,268 # 6d40 <statistics+0x14b8>
    ...
    2c58:	82c50513          	addi	a0,a0,-2004 # 6480 <statistics+0xbf8>
    ...
    2c74:	09850513          	addi	a0,a0,152 # 6d08 <statistics+0x1480>
    ...
    2c90:	10450513          	addi	a0,a0,260 # 6d90 <statistics+0x1508>
    ...
    2cac:	0a850513          	addi	a0,a0,168 # 6d50 <statistics+0x14c8>
...
0000000000002cda <subdir>:
{
  ...
  unlink("ff");
    ...
    2cec:	1f050513          	addi	a0,a0,496 # 6ed8 <statistics+0x1650>
    2cf0:	00002097          	auipc	ra,0x2
    2cf4:	6ce080e7          	jalr	1742(ra) # 53be <unlink>
  if(mkdir("dd") != 0){
    2cf8:	00004517          	auipc	a0,0x4
    2cfc:	0b050513          	addi	a0,a0,176 # 6da8 <statistics+0x1520>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d14:	0b850513          	addi	a0,a0,184 # 6dc8 <statistics+0x1540>
  ...
  write(fd, "ff", 2);
    ...
    2d2c:	1b058593          	addi	a1,a1,432 # 6ed8 <statistics+0x1650>
  ...
  if(unlink("dd") >= 0){
    ...
    2d46:	06650513          	addi	a0,a0,102 # 6da8 <statistics+0x1520>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2d5a:	0ca50513          	addi	a0,a0,202 # 6e20 <statistics+0x1598>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d72:	0da50513          	addi	a0,a0,218 # 6e48 <statistics+0x15c0>
  ...
  write(fd, "FF", 2);
    ...
    2d8a:	0f258593          	addi	a1,a1,242 # 6e78 <statistics+0x15f0>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da6:	0de50513          	addi	a0,a0,222 # 6e80 <statistics+0x15f8>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2dbe:	a1e58593          	addi	a1,a1,-1506 # b7d8 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2dd4:	a0874703          	lbu	a4,-1528(a4) # b7d8 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2dee:	0e658593          	addi	a1,a1,230 # 6ed0 <statistics+0x1648>
    2df2:	00004517          	auipc	a0,0x4
    2df6:	05650513          	addi	a0,a0,86 # 6e48 <statistics+0x15c0>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2e0a:	04250513          	addi	a0,a0,66 # 6e48 <statistics+0x15c0>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e20:	02c50513          	addi	a0,a0,44 # 6e48 <statistics+0x15c0>
  ...
  if(chdir("dd") != 0){
    ...
    2e34:	f7850513          	addi	a0,a0,-136 # 6da8 <statistics+0x1520>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2e48:	12450513          	addi	a0,a0,292 # 6f68 <statistics+0x16e0>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2e5c:	14050513          	addi	a0,a0,320 # 6f98 <statistics+0x1710>
  ...
  if(chdir("./..") != 0){
    ...
    2e70:	15c50513          	addi	a0,a0,348 # 6fc8 <statistics+0x1740>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2e86:	04e50513          	addi	a0,a0,78 # 6ed0 <statistics+0x1648>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2e9e:	93e58593          	addi	a1,a1,-1730 # b7d8 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2ec0:	f8c50513          	addi	a0,a0,-116 # 6e48 <statistics+0x15c0>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2ed8:	18450513          	addi	a0,a0,388 # 7058 <statistics+0x17d0>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2ef0:	19c50513          	addi	a0,a0,412 # 7088 <statistics+0x1800>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2f08:	ea450513          	addi	a0,a0,-348 # 6da8 <statistics+0x1520>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2f1e:	e8e50513          	addi	a0,a0,-370 # 6da8 <statistics+0x1520>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2f34:	e7850513          	addi	a0,a0,-392 # 6da8 <statistics+0x1520>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2f48:	1d458593          	addi	a1,a1,468 # 7118 <statistics+0x1890>
    2f4c:	00004517          	auipc	a0,0x4
    2f50:	10c50513          	addi	a0,a0,268 # 7058 <statistics+0x17d0>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2f64:	1b858593          	addi	a1,a1,440 # 7118 <statistics+0x1890>
    2f68:	00004517          	auipc	a0,0x4
    2f6c:	12050513          	addi	a0,a0,288 # 7088 <statistics+0x1800>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2f80:	f5458593          	addi	a1,a1,-172 # 6ed0 <statistics+0x1648>
    2f84:	00004517          	auipc	a0,0x4
    2f88:	e4450513          	addi	a0,a0,-444 # 6dc8 <statistics+0x1540>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2f9c:	0c050513          	addi	a0,a0,192 # 7058 <statistics+0x17d0>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2fb0:	0dc50513          	addi	a0,a0,220 # 7088 <statistics+0x1800>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2fc4:	f1050513          	addi	a0,a0,-240 # 6ed0 <statistics+0x1648>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2fd8:	0b450513          	addi	a0,a0,180 # 7088 <statistics+0x1800>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2fec:	07050513          	addi	a0,a0,112 # 7058 <statistics+0x17d0>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3000:	dcc50513          	addi	a0,a0,-564 # 6dc8 <statistics+0x1540>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3014:	25850513          	addi	a0,a0,600 # 7268 <statistics+0x19e0>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3028:	eac50513          	addi	a0,a0,-340 # 6ed0 <statistics+0x1648>
  ...
  if(unlink("dd/ff") != 0){
    ...
    303c:	d9050513          	addi	a0,a0,-624 # 6dc8 <statistics+0x1540>
  ...
  if(unlink("dd") == 0){
    ...
    3050:	d5c50513          	addi	a0,a0,-676 # 6da8 <statistics+0x1520>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3064:	27850513          	addi	a0,a0,632 # 72d8 <statistics+0x1a50>
  ...
  if(unlink("dd") < 0){
    ...
    3078:	d3450513          	addi	a0,a0,-716 # 6da8 <statistics+0x1520>
    ...
    309a:	d1a50513          	addi	a0,a0,-742 # 6db0 <statistics+0x1528>
    ...
    30b6:	d1e50513          	addi	a0,a0,-738 # 6dd0 <statistics+0x1548>
    ...
    30d2:	d2250513          	addi	a0,a0,-734 # 6df0 <statistics+0x1568>
    ...
    30ee:	d3e50513          	addi	a0,a0,-706 # 6e28 <statistics+0x15a0>
    ...
    310a:	d5250513          	addi	a0,a0,-686 # 6e58 <statistics+0x15d0>
    ...
    3126:	d6e50513          	addi	a0,a0,-658 # 6e90 <statistics+0x1608>
    ...
    3142:	d7250513          	addi	a0,a0,-654 # 6eb0 <statistics+0x1628>
    ...
    315e:	d8650513          	addi	a0,a0,-634 # 6ee0 <statistics+0x1658>
    ...
    317a:	d9250513          	addi	a0,a0,-622 # 6f08 <statistics+0x1680>
    ...
    3196:	d9650513          	addi	a0,a0,-618 # 6f28 <statistics+0x16a0>
    ...
    31b2:	da250513          	addi	a0,a0,-606 # 6f50 <statistics+0x16c8>
    ...
    31ce:	dae50513          	addi	a0,a0,-594 # 6f78 <statistics+0x16f0>
    ...
    31ea:	dc250513          	addi	a0,a0,-574 # 6fa8 <statistics+0x1720>
    ...
    3206:	dce50513          	addi	a0,a0,-562 # 6fd0 <statistics+0x1748>
    ...
    3222:	dca50513          	addi	a0,a0,-566 # 6fe8 <statistics+0x1760>
    ...
    323e:	dce50513          	addi	a0,a0,-562 # 7008 <statistics+0x1780>
    ...
    325a:	dd250513          	addi	a0,a0,-558 # 7028 <statistics+0x17a0>
    ...
    3276:	df650513          	addi	a0,a0,-522 # 7068 <statistics+0x17e0>
    ...
    3292:	e0a50513          	addi	a0,a0,-502 # 7098 <statistics+0x1810>
    ...
    32ae:	e0e50513          	addi	a0,a0,-498 # 70b8 <statistics+0x1830>
    ...
    32ca:	e1250513          	addi	a0,a0,-494 # 70d8 <statistics+0x1850>
    ...
    32e6:	e1650513          	addi	a0,a0,-490 # 70f8 <statistics+0x1870>
    ...
    3302:	e2a50513          	addi	a0,a0,-470 # 7128 <statistics+0x18a0>
    ...
    331e:	e3650513          	addi	a0,a0,-458 # 7150 <statistics+0x18c8>
    ...
    333a:	e4250513          	addi	a0,a0,-446 # 7178 <statistics+0x18f0>
    ...
    3356:	e4e50513          	addi	a0,a0,-434 # 71a0 <statistics+0x1918>
    ...
    3372:	e5250513          	addi	a0,a0,-430 # 71c0 <statistics+0x1938>
    ...
    338e:	e5650513          	addi	a0,a0,-426 # 71e0 <statistics+0x1958>
    ...
    33aa:	e6250513          	addi	a0,a0,-414 # 7208 <statistics+0x1980>
    ...
    33c6:	e6650513          	addi	a0,a0,-410 # 7228 <statistics+0x19a0>
    ...
    33e2:	e6a50513          	addi	a0,a0,-406 # 7248 <statistics+0x19c0>
    ...
    33fe:	e7650513          	addi	a0,a0,-394 # 7270 <statistics+0x19e8>
    ...
    341a:	af250513          	addi	a0,a0,-1294 # 6f08 <statistics+0x1680>
    ...
    3436:	e5e50513          	addi	a0,a0,-418 # 7290 <statistics+0x1a08>
    ...
    3452:	e6250513          	addi	a0,a0,-414 # 72b0 <statistics+0x1a28>
    ...
    346e:	e7650513          	addi	a0,a0,-394 # 72e0 <statistics+0x1a58>
    ...
    348a:	e7a50513          	addi	a0,a0,-390 # 7300 <statistics+0x1a78>
...
00000000000034a0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    34b0:	e6c50513          	addi	a0,a0,-404 # 7318 <statistics+0x1a90>
  ...
  if(chdir("dots") != 0){
    ...
    34c2:	e5a50513          	addi	a0,a0,-422 # 7318 <statistics+0x1a90>
  ...
  if(unlink(".") == 0){
    ...
    34d4:	e1050513          	addi	a0,a0,-496 # 62e0 <statistics+0xa58>
  ...
  if(unlink("..") == 0){
    ...
    34e6:	e8650513          	addi	a0,a0,-378 # 7368 <statistics+0x1ae0>
  ...
  if(chdir("/") != 0){
    ...
    34f8:	87c50513          	addi	a0,a0,-1924 # 6d70 <statistics+0x14e8>
  ...
  if(unlink("dots/.") == 0){
    ...
    350a:	e8250513          	addi	a0,a0,-382 # 7388 <statistics+0x1b00>
  ...
  if(unlink("dots/..") == 0){
    ...
    351c:	e9850513          	addi	a0,a0,-360 # 73b0 <statistics+0x1b28>
  ...
  if(unlink("dots") != 0){
    ...
    352e:	dee50513          	addi	a0,a0,-530 # 7318 <statistics+0x1a90>
    ...
    354c:	dd850513          	addi	a0,a0,-552 # 7320 <statistics+0x1a98>
    ...
    3568:	dd450513          	addi	a0,a0,-556 # 7338 <statistics+0x1ab0>
    ...
    3584:	dd050513          	addi	a0,a0,-560 # 7350 <statistics+0x1ac8>
    ...
    35a0:	dd450513          	addi	a0,a0,-556 # 7370 <statistics+0x1ae8>
    ...
    35bc:	7c050513          	addi	a0,a0,1984 # 6d78 <statistics+0x14f0>
    ...
    35d8:	dbc50513          	addi	a0,a0,-580 # 7390 <statistics+0x1b08>
    ...
    35f4:	dc850513          	addi	a0,a0,-568 # 73b8 <statistics+0x1b30>
    ...
    3610:	dcc50513          	addi	a0,a0,-564 # 73d8 <statistics+0x1b50>
...
0000000000003626 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    363c:	5b050513          	addi	a0,a0,1456 # 5be8 <statistics+0x360>
  ...
  if(chdir("dirfile") == 0){
    ...
    3658:	59450513          	addi	a0,a0,1428 # 5be8 <statistics+0x360>
  ...
  fd = open("dirfile/xx", 0);
    ...
    366c:	dd050513          	addi	a0,a0,-560 # 7438 <statistics+0x1bb0>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3684:	db850513          	addi	a0,a0,-584 # 7438 <statistics+0x1bb0>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3698:	da450513          	addi	a0,a0,-604 # 7438 <statistics+0x1bb0>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    36ac:	d9050513          	addi	a0,a0,-624 # 7438 <statistics+0x1bb0>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    36c0:	d7c58593          	addi	a1,a1,-644 # 7438 <statistics+0x1bb0>
    36c4:	00002517          	auipc	a0,0x2
    36c8:	71c50513          	addi	a0,a0,1820 # 5de0 <statistics+0x558>
  ...
  if(unlink("dirfile") != 0){
    ...
    36dc:	51050513          	addi	a0,a0,1296 # 5be8 <statistics+0x360>
  ...
  fd = open(".", O_RDWR);
    ...
    36f2:	bf250513          	addi	a0,a0,-1038 # 62e0 <statistics+0xa58>
  ...
  fd = open(".", 0);
    ...
    3708:	bdc50513          	addi	a0,a0,-1060 # 62e0 <statistics+0xa58>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    371c:	5a058593          	addi	a1,a1,1440 # 5cb8 <statistics+0x430>
  ...
  close(fd);
    ...
    3748:	cb450513          	addi	a0,a0,-844 # 73f8 <statistics+0x1b70>
    ...
    3764:	cb850513          	addi	a0,a0,-840 # 7418 <statistics+0x1b90>
    ...
    3780:	ccc50513          	addi	a0,a0,-820 # 7448 <statistics+0x1bc0>
    ...
    379c:	cb050513          	addi	a0,a0,-848 # 7448 <statistics+0x1bc0>
    ...
    37b8:	cbc50513          	addi	a0,a0,-836 # 7470 <statistics+0x1be8>
    ...
    37d4:	cc850513          	addi	a0,a0,-824 # 7498 <statistics+0x1c10>
    ...
    37f0:	cd450513          	addi	a0,a0,-812 # 74c0 <statistics+0x1c38>
    ...
    380c:	ce050513          	addi	a0,a0,-800 # 74e8 <statistics+0x1c60>
    ...
    3828:	ce450513          	addi	a0,a0,-796 # 7508 <statistics+0x1c80>
    ...
    3844:	cf050513          	addi	a0,a0,-784 # 7530 <statistics+0x1ca8>
...
000000000000385a <iref>:
{
    ...
    3878:	cd4a0a13          	addi	s4,s4,-812 # 7548 <statistics+0x1cc0>
    mkdir("");
    387c:	00003497          	auipc	s1,0x3
    3880:	7d448493          	addi	s1,s1,2004 # 7050 <statistics+0x17c8>
    link("README", "");
    3884:	00002a97          	auipc	s5,0x2
    3888:	55ca8a93          	addi	s5,s5,1372 # 5de0 <statistics+0x558>
    fd = open("xx", O_CREATE);
    388c:	00004997          	auipc	s3,0x4
    3890:	bb498993          	addi	s3,s3,-1100 # 7440 <statistics+0x1bb8>
    3894:	a891                	j	38e8 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3896:	85da                	mv	a1,s6
    3898:	00004517          	auipc	a0,0x4
    389c:	cb850513          	addi	a0,a0,-840 # 7550 <statistics+0x1cc8>
    ...
    38b8:	cb450513          	addi	a0,a0,-844 # 7568 <statistics+0x1ce0>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    394c:	a2098993          	addi	s3,s3,-1504 # 7368 <statistics+0x1ae0>
    unlink("irefd");
    3950:	00004917          	auipc	s2,0x4
    3954:	bf890913          	addi	s2,s2,-1032 # 7548 <statistics+0x1cc0>
    chdir("..");
    3958:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3974:	40050513          	addi	a0,a0,1024 # 6d70 <statistics+0x14e8>
...
0000000000003994 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    39a4:	be050513          	addi	a0,a0,-1056 # 7580 <statistics+0x1cf8>
  ...
  if(pid == 0){
    ...
    39c8:	bbc50513          	addi	a0,a0,-1092 # 7580 <statistics+0x1cf8>
    ...
    39de:	bc650513          	addi	a0,a0,-1082 # 75a0 <statistics+0x1d18>
    ...
    39fa:	b9250513          	addi	a0,a0,-1134 # 7588 <statistics+0x1d00>
    ...
    3a16:	a6e50513          	addi	a0,a0,-1426 # 6480 <statistics+0xbf8>
  ...
  if(unlink("oidir") != 0){
    ...
    3a44:	b4050513          	addi	a0,a0,-1216 # 7580 <statistics+0x1cf8>
    ...
    3a58:	c1c50513          	addi	a0,a0,-996 # 6670 <statistics+0xde8>
...
0000000000003a86 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3a96:	b3650513          	addi	a0,a0,-1226 # 75c8 <statistics+0x1d40>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ac2:	b0a50513          	addi	a0,a0,-1270 # 75c8 <statistics+0x1d40>
  ...
  sleep(10); // one second
    ...
    3afa:	b4a50513          	addi	a0,a0,-1206 # 6640 <statistics+0xdb8>
    ...
    3b14:	ab848493          	addi	s1,s1,-1352 # 75c8 <statistics+0x1d40>
    3b18:	4581                	li	a1,0
    3b1a:	8526                	mv	a0,s1
...
0000000000003b56 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3b7e:	ac650513          	addi	a0,a0,-1338 # 6640 <statistics+0xdb8>
  ...
  if(pid2 == 0)
    ...
    3bac:	8d850513          	addi	a0,a0,-1832 # 6480 <statistics+0xbf8>
  ...
  if(pid3 == 0){
    ...
    3bf0:	0cc58593          	addi	a1,a1,204 # 5cb8 <statistics+0x430>
    ...
    3c1a:	86a50513          	addi	a0,a0,-1942 # 6480 <statistics+0xbf8>
    ...
    3c34:	9a850513          	addi	a0,a0,-1624 # 75d8 <statistics+0x1d50>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3c54:	b8858593          	addi	a1,a1,-1144 # b7d8 <buf>
    ...
    3c6e:	98650513          	addi	a0,a0,-1658 # 75f0 <statistics+0x1d68>
  ...
  printf("kill... ");
    ...
    3c9a:	97250513          	addi	a0,a0,-1678 # 7608 <statistics+0x1d80>
  ...
  printf("wait... ");
    ...
    3cc8:	95450513          	addi	a0,a0,-1708 # 7618 <statistics+0x1d90>
...
0000000000003cf4 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    printf("%s: pipe() failed\n", s);
    3d24:	85d6                	mv	a1,s5
    3d26:	00003517          	auipc	a0,0x3
    3d2a:	86250513          	addi	a0,a0,-1950 # 6588 <statistics+0xd00>
    ...
    3d5e:	f5e58593          	addi	a1,a1,-162 # 5cb8 <statistics+0x430>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3e22:	80a50513          	addi	a0,a0,-2038 # 7628 <statistics+0x1da0>
    ...
    3e3e:	64650513          	addi	a0,a0,1606 # 6480 <statistics+0xbf8>
    ...
    3e74:	6705                	lui	a4,0x1
      n += *(a+i);
    3e76:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1818>
    ...
    3e88:	7c450513          	addi	a0,a0,1988 # 7648 <statistics+0x1dc0>
...
0000000000003ea8 <reparent>:
{
  ...
  exit(0);
    ...
    3efc:	58850513          	addi	a0,a0,1416 # 6480 <statistics+0xbf8>
    ...
    3f18:	6f450513          	addi	a0,a0,1780 # 6608 <statistics+0xd80>
...
0000000000003f58 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3fdc:	6a050513          	addi	a0,a0,1696 # 7678 <statistics+0x1df0>
...
0000000000003ffc <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4092:	60a50513          	addi	a0,a0,1546 # 7698 <statistics+0x1e10>
    ...
    40ae:	61650513          	addi	a0,a0,1558 # 76c0 <statistics+0x1e38>
  ...
  fd = open("sharedfd", 0);
    ...
    40f2:	9a250513          	addi	a0,a0,-1630 # 5a90 <statistics+0x208>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4132:	5b250513          	addi	a0,a0,1458 # 76e0 <statistics+0x1e58>
  ...
  unlink("sharedfd");
    ...
    416e:	92650513          	addi	a0,a0,-1754 # 5a90 <statistics+0x208>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4194:	57850513          	addi	a0,a0,1400 # 7708 <statistics+0x1e80>
...
00000000000041b4 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    41da:	73a78793          	addi	a5,a5,1850 # 5910 <statistics+0x88>
    41de:	f6f43823          	sd	a5,-144(s0)
    41e2:	00001797          	auipc	a5,0x1
    41e6:	73678793          	addi	a5,a5,1846 # 5918 <statistics+0x90>
    41ea:	f6f43c23          	sd	a5,-136(s0)
    41ee:	00001797          	auipc	a5,0x1
    41f2:	73278793          	addi	a5,a5,1842 # 5920 <statistics+0x98>
    41f6:	f8f43023          	sd	a5,-128(s0)
    41fa:	00001797          	auipc	a5,0x1
    41fe:	72e78793          	addi	a5,a5,1838 # 5928 <statistics+0xa0>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4256:	586a0a13          	addi	s4,s4,1414 # b7d8 <buf>
    425a:	00007a97          	auipc	s5,0x7
    425e:	57fa8a93          	addi	s5,s5,1407 # b7d9 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4276:	5fe50513          	addi	a0,a0,1534 # 6870 <statistics+0xfe8>
    ...
    42f2:	43250513          	addi	a0,a0,1074 # 7720 <statistics+0x1e98>
    ...
    430c:	42850513          	addi	a0,a0,1064 # 7730 <statistics+0x1ea8>
    ...
    4334:	41850513          	addi	a0,a0,1048 # 7748 <statistics+0x1ec0>
    ...
    4364:	47878793          	addi	a5,a5,1144 # b7d8 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    43c2:	39a50513          	addi	a0,a0,922 # 7758 <statistics+0x1ed0>
...
00000000000043f6 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4424:	350b8b93          	addi	s7,s7,848 # 7770 <statistics+0x1ee8>
  for(i = 0; i < N; i++){
    ...
    4466:	31650513          	addi	a0,a0,790 # 7778 <statistics+0x1ef0>
    ...
    4484:	2f050513          	addi	a0,a0,752 # 7770 <statistics+0x1ee8>
  ...
  fd = open(".", 0);
    ...
    44bc:	e2850513          	addi	a0,a0,-472 # 62e0 <statistics+0xa58>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4532:	26a50513          	addi	a0,a0,618 # 7798 <statistics+0x1f10>
    ...
    4552:	26a50513          	addi	a0,a0,618 # 77b8 <statistics+0x1f30>
  ...
  for(i = 0; i < N; i++){
    ...
    458a:	25a50513          	addi	a0,a0,602 # 77e0 <statistics+0x1f58>
    ...
    45a6:	ede50513          	addi	a0,a0,-290 # 6480 <statistics+0xbf8>
...
0000000000004750 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4790:	04c90913          	addi	s2,s2,76 # b7d8 <buf>
  for(i = 0; i < N; i++){
    4794:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    47d8:	04450513          	addi	a0,a0,68 # 7818 <statistics+0x1f90>
  ...
  for(i = 0; ; i++){
    ...
    47ee:	fee90913          	addi	s2,s2,-18 # b7d8 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    483c:	ff050513          	addi	a0,a0,-16 # 7828 <statistics+0x1fa0>
    ...
    4858:	ff450513          	addi	a0,a0,-12 # 7848 <statistics+0x1fc0>
    ...
    4874:	ff850513          	addi	a0,a0,-8 # 7868 <statistics+0x1fe0>
    ...
    4890:	ffc50513          	addi	a0,a0,-4 # 7888 <statistics+0x2000>
    ...
    48c8:	ffc50513          	addi	a0,a0,-4 # 78c0 <statistics+0x2038>
  ...
  unlink("bigfile.dat");
    ...
    48f6:	f2650513          	addi	a0,a0,-218 # 7818 <statistics+0x1f90>
    ...
    491a:	fca50513          	addi	a0,a0,-54 # 78e0 <statistics+0x2058>
...
0000000000004930 <dirtest>:
{
  ...
  printf("mkdir test\n");
    ...
    4940:	fc450513          	addi	a0,a0,-60 # 7900 <statistics+0x2078>
    4944:	00001097          	auipc	ra,0x1
    4948:	da2080e7          	jalr	-606(ra) # 56e6 <printf>
  if(mkdir("dir0") < 0){
    494c:	00003517          	auipc	a0,0x3
    4950:	fc450513          	addi	a0,a0,-60 # 7910 <statistics+0x2088>
  ...
  if(chdir("dir0") < 0){
    ...
    4964:	fb050513          	addi	a0,a0,-80 # 7910 <statistics+0x2088>
  ...
  if(chdir("..") < 0){
    ...
    4978:	9f450513          	addi	a0,a0,-1548 # 7368 <statistics+0x1ae0>
  ...
  if(unlink("dir0") < 0){
    ...
    498c:	f8850513          	addi	a0,a0,-120 # 7910 <statistics+0x2088>
  ...
  printf("%s: mkdir test ok\n");
    ...
    49a0:	fc450513          	addi	a0,a0,-60 # 7960 <statistics+0x20d8>
    ...
    49bc:	35050513          	addi	a0,a0,848 # 6d08 <statistics+0x1480>
    ...
    49d8:	f4450513          	addi	a0,a0,-188 # 7918 <statistics+0x2090>
    ...
    49f4:	f4050513          	addi	a0,a0,-192 # 7930 <statistics+0x20a8>
    ...
    4a10:	f3c50513          	addi	a0,a0,-196 # 7948 <statistics+0x20c0>
...
0000000000004a26 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4a48:	f3450513          	addi	a0,a0,-204 # 7978 <statistics+0x20f0>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4a68:	f24c8c93          	addi	s9,s9,-220 # 7988 <statistics+0x2100>
    int total = 0;
    4a6c:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4a6e:	00007a17          	auipc	s4,0x7
    4a72:	d6aa0a13          	addi	s4,s4,-662 # b7d8 <buf>
    name[0] = 'f';
    ...
    4ae2:	eba50513          	addi	a0,a0,-326 # 7998 <statistics+0x2110>
  ...
  printf("fsfull test finished\n");
    ...
    4b58:	e7450513          	addi	a0,a0,-396 # 79c8 <statistics+0x2140>
    ...
    4ba8:	e0c50513          	addi	a0,a0,-500 # 79b0 <statistics+0x2128>
...
0000000000004bc6 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4bd0:	3dc70713          	addi	a4,a4,988 # 7fa8 <randstate>
    4bd4:	6308                	ld	a0,0(a4)
    4bd6:	001967b7          	lui	a5,0x196
    4bda:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187e25>
    4bde:	02f50533          	mul	a0,a0,a5
    4be2:	3c6ef7b7          	lui	a5,0x3c6ef
    4be6:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e0b77>
...
0000000000004bf6 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4c6a:	d7a50513          	addi	a0,a0,-646 # 79e0 <statistics+0x2158>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4c82:	03a58593          	addi	a1,a1,58 # 5cb8 <statistics+0x430>
    ...
    4c98:	d6c50513          	addi	a0,a0,-660 # 7a00 <statistics+0x2178>
    ...
    4cb2:	d3a50513          	addi	a0,a0,-710 # 79e8 <statistics+0x2160>
    ...
    4ccc:	d2050513          	addi	a0,a0,-736 # 79e8 <statistics+0x2160>
  ...
  unlink("junk");
    ...
    4cf0:	cf450513          	addi	a0,a0,-780 # 79e0 <statistics+0x2158>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4d46:	f7698993          	addi	s3,s3,-138 # 5cb8 <statistics+0x430>
      uint64 a = (uint64) sbrk(4096);
    ...
    4d78:	cdc50513          	addi	a0,a0,-804 # 7a50 <statistics+0x21c8>
    ...
    4d92:	c8250513          	addi	a0,a0,-894 # 7a10 <statistics+0x2188>
    ...
    4dac:	c8850513          	addi	a0,a0,-888 # 7a30 <statistics+0x21a8>
  ...
  while(1){
    ...
    4dfa:	c7a50513          	addi	a0,a0,-902 # 7a70 <statistics+0x21e8>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4e4a:	c4a50513          	addi	a0,a0,-950 # 7a90 <statistics+0x2208>
  ...
  if(pid == 0) {
    ...
    4e7a:	c4250513          	addi	a0,a0,-958 # 7ab8 <statistics+0x2230>
    ...
    4e9e:	c0650513          	addi	a0,a0,-1018 # 7aa0 <statistics+0x2218>
    ...
    4ec6:	bfe50513          	addi	a0,a0,-1026 # 7ac0 <statistics+0x2238>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    4f0e:	cce78793          	addi	a5,a5,-818 # 7bd8 <statistics+0x2350>
    4f12:	c4040713          	addi	a4,s0,-960
    4f16:	00003817          	auipc	a6,0x3
    4f1a:	04280813          	addi	a6,a6,66 # 7f58 <statistics+0x26d0>
  ...
  printf("usertests starting\n");
    ...
    4f3e:	c3e50513          	addi	a0,a0,-962 # 7b78 <statistics+0x22f0>
  ...
  if(fail){
    ...
    4f76:	bbe50513          	addi	a0,a0,-1090 # 7b30 <statistics+0x22a8>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    4f92:	b3a58593          	addi	a1,a1,-1222 # 7ac8 <statistics+0x2240>
    ...
    4fa8:	c0c58593          	addi	a1,a1,-1012 # 7bb0 <statistics+0x2328>
    ...
    4fcc:	b0850513          	addi	a0,a0,-1272 # 7ad0 <statistics+0x2248>
  ...
  if(fail){
    ...
    5038:	ae450513          	addi	a0,a0,-1308 # 7b18 <statistics+0x2290>
    ...
    5052:	b1250513          	addi	a0,a0,-1262 # 7b60 <statistics+0x22d8>
    ...
    50b0:	b2c78793          	addi	a5,a5,-1236 # 7bd8 <statistics+0x2350>
    50b4:	c4040713          	addi	a4,s0,-960
    50b8:	00003817          	auipc	a6,0x3
    50bc:	ea080813          	addi	a6,a6,-352 # 7f58 <statistics+0x26d0>
    ...
    50e0:	ab450513          	addi	a0,a0,-1356 # 7b90 <statistics+0x2308>
    50e4:	00000097          	auipc	ra,0x0
    50e8:	602080e7          	jalr	1538(ra) # 56e6 <printf>
        printf("SOME TESTS FAILED\n");
    50ec:	00003a97          	auipc	s5,0x3
    50f0:	a2ca8a93          	addi	s5,s5,-1492 # 7b18 <statistics+0x2290>
        if(continuous != 2)
    50f4:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    50f6:	00003b17          	auipc	s6,0x3
    50fa:	a02b0b13          	addi	s6,s6,-1534 # 7af8 <statistics+0x2270>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5456:	b0e50513          	addi	a0,a0,-1266 # 7f60 <digits>
    545a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5522:	a42b8b93          	addi	s7,s7,-1470 # 7f60 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5662:	8fa90913          	addi	s2,s2,-1798 # 7f58 <statistics+0x26d0>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5726:	00003797          	auipc	a5,0x3
    572a:	8927b783          	ld	a5,-1902(a5) # 7fb8 <freep>
    ...
    5758:	00e6ea63          	bltu	a3,a4,576c <free+0x50>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    5772:	02059713          	slli	a4,a1,0x20
    5776:	9301                	srli	a4,a4,0x20
    5778:	0712                	slli	a4,a4,0x4
  ...
  if(p + p->s.size == bp){
    ...
    5786:	02061713          	slli	a4,a2,0x20
    578a:	9301                	srli	a4,a4,0x20
    578c:	0712                	slli	a4,a4,0x4
  ...
  freep = p;
    ...
    579a:	82f73123          	sd	a5,-2014(a4) # 7fb8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    57cc:	7f053503          	ld	a0,2032(a0) # 7fb8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    57f4:	7c890913          	addi	s2,s2,1992 # 7fb8 <freep>
  if(p == (char*)-1)
    57f8:	5afd                	li	s5,-1
    57fa:	a88d                	j	586c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    57fc:	00009797          	auipc	a5,0x9
    5800:	fdc78793          	addi	a5,a5,-36 # e7d8 <base>
    5804:	00002717          	auipc	a4,0x2
    5808:	7af73a23          	sd	a5,1972(a4) # 7fb8 <freep>
    ...
    5812:	b7e1                	j	57da <malloc+0x36>
      if(p->s.size == nunits)
    5814:	02e48b63          	beq	s1,a4,584a <malloc+0xa6>
        p->s.size -= nunits;
    ...
    5822:	0712                	slli	a4,a4,0x4
    5824:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5826:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    582a:	00002717          	auipc	a4,0x2
    582e:	78a73723          	sd	a0,1934(a4) # 7fb8 <freep>
      return (void*)(p + 1);
    5832:	01078513          	addi	a0,a5,16
    ...
    5840:	6a42                	ld	s4,16(sp)
    5842:	6aa2                	ld	s5,8(sp)
    5844:	6b02                	ld	s6,0(sp)
    5846:	6121                	addi	sp,sp,64
    5848:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    584a:	6398                	ld	a4,0(a5)
    584c:	e118                	sd	a4,0(a0)
    584e:	bff1                	j	582a <malloc+0x86>
  hp->s.size = nu;
    5850:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5854:	0541                	addi	a0,a0,16
    5856:	00000097          	auipc	ra,0x0
    585a:	ec6080e7          	jalr	-314(ra) # 571c <free>
  return freep;
    585e:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5862:	d971                	beqz	a0,5836 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5864:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5866:	4798                	lw	a4,8(a5)
    5868:	fa9776e3          	bgeu	a4,s1,5814 <malloc+0x70>
    if(p == freep)
    586c:	00093703          	ld	a4,0(s2)
    5870:	853e                	mv	a0,a5
    5872:	fef719e3          	bne	a4,a5,5864 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5876:	8552                	mv	a0,s4
    5878:	00000097          	auipc	ra,0x0
    587c:	b7e080e7          	jalr	-1154(ra) # 53f6 <sbrk>
  if(p == (char*)-1)
    5880:	fd5518e3          	bne	a0,s5,5850 <malloc+0xac>
        return 0;
    5884:	4501                	li	a0,0
    5886:	bf45                	j	5836 <malloc+0x92>

0000000000005888 <statistics>:
#include "kernel/fcntl.h"
#include "user/user.h"
...
{
    5888:	7179                	addi	sp,sp,-48
    588a:	f406                	sd	ra,40(sp)
    588c:	f022                	sd	s0,32(sp)
    588e:	ec26                	sd	s1,24(sp)
    5890:	e84a                	sd	s2,16(sp)
    5892:	e44e                	sd	s3,8(sp)
    5894:	e052                	sd	s4,0(sp)
    5896:	1800                	addi	s0,sp,48
    5898:	8a2a                	mv	s4,a0
    589a:	892e                	mv	s2,a1
  int fd, i, n;
  ...
  fd = open("statistics", O_RDONLY);
    589c:	4581                	li	a1,0
    589e:	00002517          	auipc	a0,0x2
    58a2:	6da50513          	addi	a0,a0,1754 # 7f78 <digits+0x18>
    58a6:	00000097          	auipc	ra,0x0
    58aa:	b08080e7          	jalr	-1272(ra) # 53ae <open>
  if(fd < 0) {
    58ae:	04054263          	bltz	a0,58f2 <statistics+0x6a>
    58b2:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    58b4:	4481                	li	s1,0
    58b6:	03205063          	blez	s2,58d6 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    58ba:	4099063b          	subw	a2,s2,s1
    58be:	009a05b3          	add	a1,s4,s1
    58c2:	854e                	mv	a0,s3
    58c4:	00000097          	auipc	ra,0x0
    58c8:	ac2080e7          	jalr	-1342(ra) # 5386 <read>
    58cc:	00054563          	bltz	a0,58d6 <statistics+0x4e>
      break;
    }
    i += n;
    58d0:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    58d2:	ff24c4e3          	blt	s1,s2,58ba <statistics+0x32>
  }
  close(fd);
    58d6:	854e                	mv	a0,s3
    58d8:	00000097          	auipc	ra,0x0
    58dc:	abe080e7          	jalr	-1346(ra) # 5396 <close>
  return i;
}
    58e0:	8526                	mv	a0,s1
    58e2:	70a2                	ld	ra,40(sp)
    58e4:	7402                	ld	s0,32(sp)
    58e6:	64e2                	ld	s1,24(sp)
    58e8:	6942                	ld	s2,16(sp)
    58ea:	69a2                	ld	s3,8(sp)
    58ec:	6a02                	ld	s4,0(sp)
    58ee:	6145                	addi	sp,sp,48
    58f0:	8082                	ret
      fprintf(2, "stats: open failed\n");
    58f2:	00002597          	auipc	a1,0x2
    58f6:	69658593          	addi	a1,a1,1686 # 7f88 <digits+0x28>
    58fa:	4509                	li	a0,2
    58fc:	00000097          	auipc	ra,0x0
    5900:	dbc080e7          	jalr	-580(ra) # 56b8 <fprintf>
      exit(1);
    5904:	4505                	li	a0,1
    5906:	00000097          	auipc	ra,0x0
    590a:	a68080e7          	jalr	-1432(ra) # 536e <exit>
