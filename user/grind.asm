 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	addi	a3,a3,797 # 1f31d <__global_pointer$+0x1d419>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	addi	a2,a2,423 # 41a7 <__global_pointer$+0x22a3>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd5e8>
...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	35e50513          	addi	a0,a0,862 # 13f8 <statistics+0x88>
      a2:	00001097          	auipc	ra,0x1
      a6:	e1c080e7          	jalr	-484(ra) # ebe <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	34e50513          	addi	a0,a0,846 # 13f8 <statistics+0x88>
      b2:	00001097          	auipc	ra,0x1
      b6:	e14080e7          	jalr	-492(ra) # ec6 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	34450513          	addi	a0,a0,836 # 1400 <statistics+0x90>
  ...
  chdir("/");
      ...
      da:	34250513          	addi	a0,a0,834 # 1418 <statistics+0xa8>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	34298993          	addi	s3,s3,834 # 1428 <statistics+0xb8>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	33098993          	addi	s3,s3,816 # 1420 <statistics+0xb0>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
      ...
      sbrk(6011);
      fc:	6a85                	lui	s5,0x1
      fe:	77ba8a93          	addi	s5,s5,1915 # 177b <buf.0+0x63>
     102:	a825                	j	13a <go+0xc2>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     104:	20200593          	li	a1,514
     108:	00001517          	auipc	a0,0x1
     10c:	32850513          	addi	a0,a0,808 # 1430 <statistics+0xc0>
    ...
    if(what == 1){
     ...
     292:	3ba58593          	addi	a1,a1,954 # 1648 <statistics+0x2d8>
     ...
     2b6:	3e650513          	addi	a0,a0,998 # 1698 <statistics+0x328>
     ...
     2d4:	17050513          	addi	a0,a0,368 # 1440 <statistics+0xd0>
     ...
     35c:	10850513          	addi	a0,a0,264 # 1460 <statistics+0xf0>
     ...
     37e:	0f650513          	addi	a0,a0,246 # 1470 <statistics+0x100>
     ...
     396:	38658593          	addi	a1,a1,902 # 1718 <buf.0>
     39a:	854a                	mv	a0,s2
     ...
     3ae:	36e58593          	addi	a1,a1,878 # 1718 <buf.0>
     3b2:	854a                	mv	a0,s2
     ...
     4b4:	04050513          	addi	a0,a0,64 # 14f0 <statistics+0x180>
     ...
     502:	ff250513          	addi	a0,a0,-14 # 14f0 <statistics+0x180>
     ...
     55e:	fae50513          	addi	a0,a0,-82 # 1508 <statistics+0x198>
     ...
     58a:	f4a50513          	addi	a0,a0,-182 # 14d0 <statistics+0x160>
     ...
     5ac:	f4850513          	addi	a0,a0,-184 # 14f0 <statistics+0x180>
     ...
     5c6:	f5650513          	addi	a0,a0,-170 # 1518 <statistics+0x1a8>
     ...
     614:	ee050513          	addi	a0,a0,-288 # 14f0 <statistics+0x180>
     ...
     670:	ebc50513          	addi	a0,a0,-324 # 1528 <statistics+0x1b8>
     ...
     69c:	ea858593          	addi	a1,a1,-344 # 1540 <statistics+0x1d0>
     ...
     79e:	dee50513          	addi	a0,a0,-530 # 1588 <statistics+0x218>
     ...
     7b8:	de450513          	addi	a0,a0,-540 # 1598 <statistics+0x228>
     7bc:	00000097          	auipc	ra,0x0
     7c0:	6ea080e7          	jalr	1770(ra) # ea6 <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     7c4:	20200593          	li	a1,514
     7c8:	00001517          	auipc	a0,0x1
     7cc:	dd050513          	addi	a0,a0,-560 # 1598 <statistics+0x228>
     ...
     7e4:	d6058593          	addi	a1,a1,-672 # 1540 <statistics+0x1d0>
     ...
     856:	d6650513          	addi	a0,a0,-666 # 15b8 <statistics+0x248>
     ...
     870:	d5c50513          	addi	a0,a0,-676 # 15c8 <statistics+0x258>
     ...
     88c:	d5050513          	addi	a0,a0,-688 # 15d8 <statistics+0x268>
     ...
     8a6:	d5650513          	addi	a0,a0,-682 # 15f8 <statistics+0x288>
     ...
     8c0:	d6458593          	addi	a1,a1,-668 # 1620 <statistics+0x2b0>
     8c4:	4509                	li	a0,2
     ...
     8dc:	d4858593          	addi	a1,a1,-696 # 1620 <statistics+0x2b0>
     8e0:	4509                	li	a0,2
     ...
     938:	cfc58593          	addi	a1,a1,-772 # 1630 <statistics+0x2c0>
     93c:	4509                	li	a0,2
     ...
     9ac:	be058593          	addi	a1,a1,-1056 # 1588 <statistics+0x218>
     9b0:	4509                	li	a0,2
     ...
     9f8:	c3c58593          	addi	a1,a1,-964 # 1630 <statistics+0x2c0>
     9fc:	4509                	li	a0,2
     ...
     a3c:	bf858593          	addi	a1,a1,-1032 # 1630 <statistics+0x2c0>
     a40:	4509                	li	a0,2
     ...
     aa4:	ae858593          	addi	a1,a1,-1304 # 1588 <statistics+0x218>
     aa8:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     acc:	a0850513          	addi	a0,a0,-1528 # 14d0 <statistics+0x160>
     ad0:	00000097          	auipc	ra,0x0
     ad4:	3d6080e7          	jalr	982(ra) # ea6 <unlink>
  unlink("b");
     ad8:	00001517          	auipc	a0,0x1
     adc:	9a850513          	addi	a0,a0,-1624 # 1480 <statistics+0x110>
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     afe:	c0f73723          	sd	a5,-1010(a4) # 1708 <rand_next>
    go(0);
     b02:	4501                	li	a0,0
    ...
    printf("grind: fork failed\n");
     ...
     b10:	9e450513          	addi	a0,a0,-1564 # 14f0 <statistics+0x180>
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     b36:	6789                	lui	a5,0x2
     b38:	c0978793          	addi	a5,a5,-1015 # 1c09 <__BSS_END__+0xf9>
     b3c:	00001717          	auipc	a4,0x1
     b40:	bcf73623          	sd	a5,-1076(a4) # 1708 <rand_next>
    go(1);
     b44:	4505                	li	a0,1
    ...
    printf("grind: fork failed\n");
     ...
     b52:	9a250513          	addi	a0,a0,-1630 # 14f0 <statistics+0x180>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f3e:	78e50513          	addi	a0,a0,1934 # 16c8 <digits>
     f42:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    100a:	6c2b8b93          	addi	s7,s7,1730 # 16c8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    114a:	57a90913          	addi	s2,s2,1402 # 16c0 <statistics+0x350>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1212:	5027b783          	ld	a5,1282(a5) # 1710 <freep>
    ...
    1240:	00e6ea63          	bltu	a3,a4,1254 <free+0x50>
{
  ...
  freep = p;
    ...
    1282:	48f73923          	sd	a5,1170(a4) # 1710 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12b4:	46053503          	ld	a0,1120(a0) # 1710 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12dc:	43890913          	addi	s2,s2,1080 # 1710 <freep>
  if(p == (char*)-1)
    12e0:	5afd                	li	s5,-1
    12e2:	a88d                	j	1354 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    12e4:	00001797          	auipc	a5,0x1
    12e8:	81c78793          	addi	a5,a5,-2020 # 1b00 <base>
    12ec:	00000717          	auipc	a4,0x0
    12f0:	42f73223          	sd	a5,1060(a4) # 1710 <freep>
    ...
    1316:	3ea73f23          	sd	a0,1022(a4) # 1710 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
    ...
    1376:	ec26                	sd	s1,24(sp)
    1378:	e84a                	sd	s2,16(sp)
    137a:	e44e                	sd	s3,8(sp)
    137c:	e052                	sd	s4,0(sp)
  ...
  fd = open("statistics", O_RDONLY);
    1384:	4581                	li	a1,0
    1386:	00000517          	auipc	a0,0x0
    138a:	35a50513          	addi	a0,a0,858 # 16e0 <digits+0x18>
    138e:	00000097          	auipc	ra,0x0
    1392:	b08080e7          	jalr	-1272(ra) # e96 <open>
  if(fd < 0) {
    1396:	04054263          	bltz	a0,13da <statistics+0x6a>
    139a:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    139c:	4481                	li	s1,0
    139e:	03205063          	blez	s2,13be <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    13a2:	4099063b          	subw	a2,s2,s1
    13a6:	009a05b3          	add	a1,s4,s1
    13aa:	854e                	mv	a0,s3
    13ac:	00000097          	auipc	ra,0x0
    13b0:	ac2080e7          	jalr	-1342(ra) # e6e <read>
    13b4:	00054563          	bltz	a0,13be <statistics+0x4e>
      break;
    }
    i += n;
    13b8:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    13ba:	ff24c4e3          	blt	s1,s2,13a2 <statistics+0x32>
  }
  close(fd);
    13be:	854e                	mv	a0,s3
    13c0:	00000097          	auipc	ra,0x0
    13c4:	abe080e7          	jalr	-1346(ra) # e7e <close>
  return i;
}
    13c8:	8526                	mv	a0,s1
    13ca:	70a2                	ld	ra,40(sp)
    13cc:	7402                	ld	s0,32(sp)
    13ce:	64e2                	ld	s1,24(sp)
    13d0:	6942                	ld	s2,16(sp)
    13d2:	69a2                	ld	s3,8(sp)
    13d4:	6a02                	ld	s4,0(sp)
    13d6:	6145                	addi	sp,sp,48
    13d8:	8082                	ret
      fprintf(2, "stats: open failed\n");
    13da:	00000597          	auipc	a1,0x0
    13de:	31658593          	addi	a1,a1,790 # 16f0 <digits+0x28>
    13e2:	4509                	li	a0,2
    13e4:	00000097          	auipc	ra,0x0
    13e8:	dbc080e7          	jalr	-580(ra) # 11a0 <fprintf>
      exit(1);
    13ec:	4505                	li	a0,1
    13ee:	00000097          	auipc	ra,0x0
    13f2:	a68080e7          	jalr	-1432(ra) # e56 <exit>
