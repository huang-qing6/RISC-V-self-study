...
00000000000001de <main>:
{
 ...
 252:	86258593          	addi	a1,a1,-1950 # ab0 <statistics+0x8a>
 256:	4509                	li	a0,2
 ...
 288:	84c50513          	addi	a0,a0,-1972 # ad0 <statistics+0xaa>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5f4:	50050513          	addi	a0,a0,1280 # af0 <digits>
 5f8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6c0:	434b8b93          	addi	s7,s7,1076 # af0 <digits>
 ...
 800:	2ec90913          	addi	s2,s2,748 # ae8 <statistics+0xc2>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8c8:	26c7b783          	ld	a5,620(a5) # b30 <freep>
 ...
 8f6:	00e6ea63          	bltu	a3,a4,90a <free+0x50>
{
 ...
 938:	1ef73e23          	sd	a5,508(a4) # b30 <freep>
}
 93c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 96a:	1ca53503          	ld	a0,458(a0) # b30 <freep>
 ...
 992:	1a290913          	addi	s2,s2,418 # b30 <freep>
  if(p == (char*)-1)
 996:	5afd                	li	s5,-1
 998:	a88d                	j	a0a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 99a:	00000797          	auipc	a5,0x0
 99e:	59e78793          	addi	a5,a5,1438 # f38 <base>
 9a2:	00000717          	auipc	a4,0x0
 9a6:	18f73723          	sd	a5,398(a4) # b30 <freep>
 9aa:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9cc:	16a73423          	sd	a0,360(a4) # b30 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 a40:	0cc50513          	addi	a0,a0,204 # b08 <digits+0x18>
 a44:	00000097          	auipc	ra,0x0
 a48:	b08080e7          	jalr	-1272(ra) # 54c <open>
  if(fd < 0) {
 a4c:	04054263          	bltz	a0,a90 <statistics+0x6a>
 a50:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 a52:	4481                	li	s1,0
 a54:	03205063          	blez	s2,a74 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 a58:	4099063b          	subw	a2,s2,s1
 a5c:	009a05b3          	add	a1,s4,s1
 a60:	854e                	mv	a0,s3
 a62:	00000097          	auipc	ra,0x0
 a66:	ac2080e7          	jalr	-1342(ra) # 524 <read>
 a6a:	00054563          	bltz	a0,a74 <statistics+0x4e>
      break;
    }
    i += n;
 a6e:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 a70:	ff24c4e3          	blt	s1,s2,a58 <statistics+0x32>
  }
  close(fd);
 a74:	854e                	mv	a0,s3
 a76:	00000097          	auipc	ra,0x0
 a7a:	abe080e7          	jalr	-1346(ra) # 534 <close>
  return i;
}
 a7e:	8526                	mv	a0,s1
 ...
 a8e:	8082                	ret
      fprintf(2, "stats: open failed\n");
 a90:	00000597          	auipc	a1,0x0
 a94:	08858593          	addi	a1,a1,136 # b18 <digits+0x28>
 a98:	4509                	li	a0,2
 a9a:	00000097          	auipc	ra,0x0
 a9e:	dbc080e7          	jalr	-580(ra) # 856 <fprintf>
      exit(1);
 aa2:	4505                	li	a0,1
 aa4:	00000097          	auipc	ra,0x0
 aa8:	a68080e7          	jalr	-1432(ra) # 50c <exit>
