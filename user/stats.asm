...
main(void)
{
  ...
  16:	8bea0a13          	addi	s4,s4,-1858 # 8d0 <buf>
  1a:	00001a97          	auipc	s5,0x1
  1e:	8b7a8a93          	addi	s5,s5,-1865 # 8d1 <buf+0x1>
  22:	6585                	lui	a1,0x1
  24:	8552                	mv	a0,s4
  26:	00000097          	auipc	ra,0x0
  2a:	7ce080e7          	jalr	1998(ra) # 7f4 <statistics>
  2e:	89aa                	mv	s3,a0
    for (i = 0; i < n; i++) {
  30:	02a05663          	blez	a0,5c <main+0x5c>
  34:	00001497          	auipc	s1,0x1
  38:	89c48493          	addi	s1,s1,-1892 # 8d0 <buf>
  ...
  52:	2ac080e7          	jalr	684(ra) # 2fa <write>
    for (i = 0; i < n; i++) {
...
strcpy(char *s, const char *t)
{
  ...
  78:	fff5c703          	lbu	a4,-1(a1) # fff <buf+0x72f>
  7c:	fee78fa3          	sb	a4,-1(a5) # fff <buf+0x72f>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48e:	3feb8b93          	addi	s7,s7,1022 # 888 <digits>
 ...
 5ce:	2b690913          	addi	s2,s2,694 # 880 <statistics+0x8c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 696:	2367b783          	ld	a5,566(a5) # 8c8 <freep>
 ...
 6c4:	00e6ea63          	bltu	a3,a4,6d8 <free+0x50>
{
 ...
 706:	1cf73323          	sd	a5,454(a4) # 8c8 <freep>
}
 70a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 738:	19453503          	ld	a0,404(a0) # 8c8 <freep>
 ...
 760:	16c90913          	addi	s2,s2,364 # 8c8 <freep>
  if(p == (char*)-1)
 764:	5afd                	li	s5,-1
 766:	a88d                	j	7d8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 768:	00001797          	auipc	a5,0x1
 76c:	16878793          	addi	a5,a5,360 # 18d0 <base>
 770:	00000717          	auipc	a4,0x0
 774:	14f73c23          	sd	a5,344(a4) # 8c8 <freep>
 778:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 79a:	12a73923          	sd	a0,306(a4) # 8c8 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 80e:	09650513          	addi	a0,a0,150 # 8a0 <digits+0x18>
 ...
 862:	05258593          	addi	a1,a1,82 # 8b0 <digits+0x28>
 866:	4509                	li	a0,2
