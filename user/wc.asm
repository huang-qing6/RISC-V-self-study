...
wc(int fd, char *name)
{
  ...
  3c:	970a0a13          	addi	s4,s4,-1680 # 9a8 <statistics+0x8a>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	90a50513          	addi	a0,a0,-1782 # 9c0 <statistics+0xa2>
  ...
  e8:	8cc50513          	addi	a0,a0,-1844 # 9b0 <statistics+0x92>
...
main(int argc, char *argv[])
{
 ...
 162:	87258593          	addi	a1,a1,-1934 # 9d0 <statistics+0xb2>
 166:	4501                	li	a0,0
 ...
 180:	85c50513          	addi	a0,a0,-1956 # 9d8 <statistics+0xba>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b8:	444b8b93          	addi	s7,s7,1092 # 9f8 <digits>
 ...
 6f8:	2fc90913          	addi	s2,s2,764 # 9f0 <statistics+0xd2>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7c0:	27c7b783          	ld	a5,636(a5) # a38 <freep>
 ...
 7ee:	00e6ea63          	bltu	a3,a4,802 <free+0x50>
{
 ...
 830:	20f73623          	sd	a5,524(a4) # a38 <freep>
}
 834:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 862:	1da53503          	ld	a0,474(a0) # a38 <freep>
 ...
 88a:	1b290913          	addi	s2,s2,434 # a38 <freep>
  if(p == (char*)-1)
 88e:	5afd                	li	s5,-1
 890:	a88d                	j	902 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 892:	00000797          	auipc	a5,0x0
 896:	3ae78793          	addi	a5,a5,942 # c40 <base>
 89a:	00000717          	auipc	a4,0x0
 89e:	18f73f23          	sd	a5,414(a4) # a38 <freep>
 8a2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8c4:	16a73c23          	sd	a0,376(a4) # a38 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 938:	0dc50513          	addi	a0,a0,220 # a10 <digits+0x18>
 93c:	00000097          	auipc	ra,0x0
 940:	b08080e7          	jalr	-1272(ra) # 444 <open>
  if(fd < 0) {
 944:	04054263          	bltz	a0,988 <statistics+0x6a>
 948:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 94a:	4481                	li	s1,0
 94c:	03205063          	blez	s2,96c <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 950:	4099063b          	subw	a2,s2,s1
 954:	009a05b3          	add	a1,s4,s1
 958:	854e                	mv	a0,s3
 95a:	00000097          	auipc	ra,0x0
 95e:	ac2080e7          	jalr	-1342(ra) # 41c <read>
 962:	00054563          	bltz	a0,96c <statistics+0x4e>
      break;
    }
    i += n;
 966:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 968:	ff24c4e3          	blt	s1,s2,950 <statistics+0x32>
  }
  close(fd);
 96c:	854e                	mv	a0,s3
 96e:	00000097          	auipc	ra,0x0
 972:	abe080e7          	jalr	-1346(ra) # 42c <close>
  return i;
}
 976:	8526                	mv	a0,s1
 ...
 986:	8082                	ret
      fprintf(2, "stats: open failed\n");
 988:	00000597          	auipc	a1,0x0
 98c:	09858593          	addi	a1,a1,152 # a20 <digits+0x28>
 990:	4509                	li	a0,2
 992:	00000097          	auipc	ra,0x0
 996:	dbc080e7          	jalr	-580(ra) # 74e <fprintf>
      exit(1);
 99a:	4505                	li	a0,1
 99c:	00000097          	auipc	ra,0x0
 9a0:	a68080e7          	jalr	-1432(ra) # 404 <exit>
