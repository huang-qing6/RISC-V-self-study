...
main(int argc, char *argv[])
{
  ...
  1a:	93a78793          	addi	a5,a5,-1734 # 950 <statistics+0xbc>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8f450513          	addi	a0,a0,-1804 # 920 <statistics+0x8c>
  ...
  6c:	8d050513          	addi	a0,a0,-1840 # 938 <statistics+0xa4>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	89250513          	addi	a0,a0,-1902 # 948 <statistics+0xb4>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 66e:	2f690913          	addi	s2,s2,758 # 960 <statistics+0xcc>
        while(*s != 0){
...
free(void *ap)
{
 ...
 736:	2767b783          	ld	a5,630(a5) # 9a8 <freep>
 ...
 764:	00e6ea63          	bltu	a3,a4,778 <free+0x50>
{
 ...
 7a6:	20f73323          	sd	a5,518(a4) # 9a8 <freep>
}
 7aa:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7d8:	1d453503          	ld	a0,468(a0) # 9a8 <freep>
 ...
 800:	1ac90913          	addi	s2,s2,428 # 9a8 <freep>
  if(p == (char*)-1)
 804:	5afd                	li	s5,-1
 ...
 83a:	16a73923          	sd	a0,370(a4) # 9a8 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8ae:	0d650513          	addi	a0,a0,214 # 980 <digits+0x18>
 ...
 902:	09258593          	addi	a1,a1,146 # 990 <digits+0x28>
 906:	4509                	li	a0,2
