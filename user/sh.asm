...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	35858593          	addi	a1,a1,856 # 1368 <statistics+0x8c>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	31258593          	addi	a1,a1,786 # 1370 <statistics+0x94>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2e050513          	addi	a0,a0,736 # 1378 <statistics+0x9c>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3b470713          	addi	a4,a4,948 # 1478 <statistics+0x19c>
    ...
    panic("runcmd");
      ...
      e2:	2a250513          	addi	a0,a0,674 # 1380 <statistics+0xa4>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	28858593          	addi	a1,a1,648 # 1388 <statistics+0xac>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	24c58593          	addi	a1,a1,588 # 1398 <statistics+0xbc>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	1c650513          	addi	a0,a0,454 # 13a8 <statistics+0xcc>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	e2eb8b93          	addi	s7,s7,-466 # 13d0 <statistics+0xf4>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	dfc50513          	addi	a0,a0,-516 # 13b0 <statistics+0xd4>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d3c60613          	addi	a2,a2,-708 # 13d8 <statistics+0xfc>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	d2cb0b13          	addi	s6,s6,-724 # 13f8 <statistics+0x11c>
  ...
  return ret;
     ...
     70a:	cda50513          	addi	a0,a0,-806 # 13e0 <statistics+0x104>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c8050513          	addi	a0,a0,-896 # 13e8 <statistics+0x10c>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c5e60613          	addi	a2,a2,-930 # 1400 <statistics+0x124>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	bf6a0a13          	addi	s4,s4,-1034 # 1408 <statistics+0x12c>
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	bc860613          	addi	a2,a2,-1080 # 1410 <statistics+0x134>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	b2a60613          	addi	a2,a2,-1238 # 13d8 <statistics+0xfc>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b4a60613          	addi	a2,a2,-1206 # 1428 <statistics+0x14c>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	af850513          	addi	a0,a0,-1288 # 1418 <statistics+0x13c>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	b0050513          	addi	a0,a0,-1280 # 1430 <statistics+0x154>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	b3470713          	addi	a4,a4,-1228 # 1490 <statistics+0x1b4>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a4060613          	addi	a2,a2,-1472 # 1448 <statistics+0x16c>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	a1258593          	addi	a1,a1,-1518 # 1450 <statistics+0x174>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	6c4080e7          	jalr	1732(ra) # 110c <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	99050513          	addi	a0,a0,-1648 # 13e0 <statistics+0x104>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	9ee48493          	addi	s1,s1,-1554 # 1460 <statistics+0x184>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a7048493          	addi	s1,s1,-1424 # 1508 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	a63a0a13          	addi	s4,s4,-1437 # 150b <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	9b8a8a93          	addi	s5,s5,-1608 # 1468 <statistics+0x18c>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	9d650513          	addi	a0,a0,-1578 # 1508 <buf.0>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10b6:	3f690913          	addi	s2,s2,1014 # 14a8 <statistics+0x1cc>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    117e:	3867b783          	ld	a5,902(a5) # 1500 <freep>
    ...
    11ac:	00e6ea63          	bltu	a3,a4,11c0 <free+0x50>
{
  ...
  freep = p;
    ...
    11ee:	30f73b23          	sd	a5,790(a4) # 1500 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1220:	2e453503          	ld	a0,740(a0) # 1500 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1248:	2bc90913          	addi	s2,s2,700 # 1500 <freep>
  if(p == (char*)-1)
    124c:	5afd                	li	s5,-1
    124e:	a88d                	j	12c0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1250:	00000797          	auipc	a5,0x0
    1254:	32078793          	addi	a5,a5,800 # 1570 <base>
    1258:	00000717          	auipc	a4,0x0
    125c:	2af73423          	sd	a5,680(a4) # 1500 <freep>
    ...
    1282:	28a73123          	sd	a0,642(a4) # 1500 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
    ...
    12e2:	ec26                	sd	s1,24(sp)
    12e4:	e84a                	sd	s2,16(sp)
    12e6:	e44e                	sd	s3,8(sp)
    12e8:	e052                	sd	s4,0(sp)
  ...
  fd = open("statistics", O_RDONLY);
    12f0:	4581                	li	a1,0
    12f2:	00000517          	auipc	a0,0x0
    12f6:	1d650513          	addi	a0,a0,470 # 14c8 <digits+0x18>
    12fa:	00000097          	auipc	ra,0x0
    12fe:	b08080e7          	jalr	-1272(ra) # e02 <open>
  if(fd < 0) {
    1302:	04054263          	bltz	a0,1346 <statistics+0x6a>
    1306:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    1308:	4481                	li	s1,0
    130a:	03205063          	blez	s2,132a <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    130e:	4099063b          	subw	a2,s2,s1
    1312:	009a05b3          	add	a1,s4,s1
    1316:	854e                	mv	a0,s3
    1318:	00000097          	auipc	ra,0x0
    131c:	ac2080e7          	jalr	-1342(ra) # dda <read>
    1320:	00054563          	bltz	a0,132a <statistics+0x4e>
      break;
    }
    i += n;
    1324:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    1326:	ff24c4e3          	blt	s1,s2,130e <statistics+0x32>
  }
  close(fd);
    132a:	854e                	mv	a0,s3
    132c:	00000097          	auipc	ra,0x0
    1330:	abe080e7          	jalr	-1346(ra) # dea <close>
  return i;
}
    1334:	8526                	mv	a0,s1
    1336:	70a2                	ld	ra,40(sp)
    1338:	7402                	ld	s0,32(sp)
    133a:	64e2                	ld	s1,24(sp)
    133c:	6942                	ld	s2,16(sp)
    133e:	69a2                	ld	s3,8(sp)
    1340:	6a02                	ld	s4,0(sp)
    1342:	6145                	addi	sp,sp,48
    1344:	8082                	ret
      fprintf(2, "stats: open failed\n");
    1346:	00000597          	auipc	a1,0x0
    134a:	19258593          	addi	a1,a1,402 # 14d8 <digits+0x28>
    134e:	4509                	li	a0,2
    1350:	00000097          	auipc	ra,0x0
    1354:	dbc080e7          	jalr	-580(ra) # 110c <fprintf>
      exit(1);
    1358:	4505                	li	a0,1
    135a:	00000097          	auipc	ra,0x0
    135e:	a68080e7          	jalr	-1432(ra) # dc2 <exit>
