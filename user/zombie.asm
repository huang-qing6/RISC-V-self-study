...
printint(int fd, int xx, int base, int sgn)
{
 ...
 380:	4c450513          	addi	a0,a0,1220 # 840 <digits>
 384:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 44c:	3f8b8b93          	addi	s7,s7,1016 # 840 <digits>
 ...
 58c:	2b090913          	addi	s2,s2,688 # 838 <statistics+0x86>
        while(*s != 0){
...
free(void *ap)
{
 ...
 654:	2307b783          	ld	a5,560(a5) # 880 <freep>
 ...
 682:	00e6ea63          	bltu	a3,a4,696 <free+0x50>
{
 ...
 6c4:	1cf73023          	sd	a5,448(a4) # 880 <freep>
}
 6c8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6f6:	18e53503          	ld	a0,398(a0) # 880 <freep>
 ...
 71e:	16690913          	addi	s2,s2,358 # 880 <freep>
  if(p == (char*)-1)
 722:	5afd                	li	s5,-1
 724:	a88d                	j	796 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 726:	00000797          	auipc	a5,0x0
 72a:	16278793          	addi	a5,a5,354 # 888 <base>
 ...
 758:	12a73623          	sd	a0,300(a4) # 880 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 7b8:	ec26                	sd	s1,24(sp)
 7ba:	e84a                	sd	s2,16(sp)
 7bc:	e44e                	sd	s3,8(sp)
 7be:	e052                	sd	s4,0(sp)
 ...
 7cc:	09050513          	addi	a0,a0,144 # 858 <digits+0x18>
 7d0:	00000097          	auipc	ra,0x0
 7d4:	b08080e7          	jalr	-1272(ra) # 2d8 <open>
  if(fd < 0) {
 7d8:	04054263          	bltz	a0,81c <statistics+0x6a>
 7dc:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 7de:	4481                	li	s1,0
 7e0:	03205063          	blez	s2,800 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 7e4:	4099063b          	subw	a2,s2,s1
 7e8:	009a05b3          	add	a1,s4,s1
 7ec:	854e                	mv	a0,s3
 7ee:	00000097          	auipc	ra,0x0
 7f2:	ac2080e7          	jalr	-1342(ra) # 2b0 <read>
 7f6:	00054563          	bltz	a0,800 <statistics+0x4e>
      break;
    }
    i += n;
 7fa:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 7fc:	ff24c4e3          	blt	s1,s2,7e4 <statistics+0x32>
  }
  close(fd);
 800:	854e                	mv	a0,s3
 802:	00000097          	auipc	ra,0x0
 806:	abe080e7          	jalr	-1346(ra) # 2c0 <close>
  return i;
}
 80a:	8526                	mv	a0,s1
 80c:	70a2                	ld	ra,40(sp)
 80e:	7402                	ld	s0,32(sp)
 810:	64e2                	ld	s1,24(sp)
 812:	6942                	ld	s2,16(sp)
 814:	69a2                	ld	s3,8(sp)
 816:	6a02                	ld	s4,0(sp)
 ...
 820:	04c58593          	addi	a1,a1,76 # 868 <digits+0x28>
 824:	4509                	li	a0,2
 826:	00000097          	auipc	ra,0x0
 82a:	dbc080e7          	jalr	-580(ra) # 5e2 <fprintf>
      exit(1);
 82e:	4505                	li	a0,1
 830:	00000097          	auipc	ra,0x0
 834:	a68080e7          	jalr	-1432(ra) # 298 <exit>
