...
main(int argc, char **argv)
{
  ...
  4c:	83058593          	addi	a1,a1,-2000 # 878 <statistics+0x8c>
  50:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5c6:	2ce90913          	addi	s2,s2,718 # 890 <statistics+0xa4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 68e:	24e7b783          	ld	a5,590(a5) # 8d8 <freep>
 ...
 6bc:	00e6ea63          	bltu	a3,a4,6d0 <free+0x50>
{
 ...
 6fe:	1cf73f23          	sd	a5,478(a4) # 8d8 <freep>
}
 702:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 730:	1ac53503          	ld	a0,428(a0) # 8d8 <freep>
 ...
 758:	18490913          	addi	s2,s2,388 # 8d8 <freep>
  if(p == (char*)-1)
 75c:	5afd                	li	s5,-1
 75e:	a88d                	j	7d0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 760:	00000797          	auipc	a5,0x0
 764:	18078793          	addi	a5,a5,384 # 8e0 <base>
 768:	00000717          	auipc	a4,0x0
 76c:	16f73823          	sd	a5,368(a4) # 8d8 <freep>
 770:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 792:	14a73523          	sd	a0,330(a4) # 8d8 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 806:	0ae50513          	addi	a0,a0,174 # 8b0 <digits+0x18>
 80a:	00000097          	auipc	ra,0x0
 80e:	b08080e7          	jalr	-1272(ra) # 312 <open>
  if(fd < 0) {
 ...
 82c:	ac2080e7          	jalr	-1342(ra) # 2ea <read>
 ...
 840:	abe080e7          	jalr	-1346(ra) # 2fa <close>
  return i;
}
 844:	8526                	mv	a0,s1
 ...
 85a:	06a58593          	addi	a1,a1,106 # 8c0 <digits+0x28>
 85e:	4509                	li	a0,2
 860:	00000097          	auipc	ra,0x0
 864:	dbc080e7          	jalr	-580(ra) # 61c <fprintf>
      exit(1);
 868:	4505                	li	a0,1
 86a:	00000097          	auipc	ra,0x0
 86e:	a68080e7          	jalr	-1432(ra) # 2d2 <exit>
