...
main(int argc, char *argv[])
{
  ...
  42:	84a58593          	addi	a1,a1,-1974 # 888 <statistics+0x88>
  46:	4509                	li	a0,2
  ...
  60:	84458593          	addi	a1,a1,-1980 # 8a0 <statistics+0xa0>
  64:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49a:	432b8b93          	addi	s7,s7,1074 # 8c8 <digits>
 ...
 5da:	2ea90913          	addi	s2,s2,746 # 8c0 <statistics+0xc0>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a2:	26a7b783          	ld	a5,618(a5) # 908 <freep>
 ...
 6d0:	00e6ea63          	bltu	a3,a4,6e4 <free+0x50>
{
 ...
 712:	1ef73d23          	sd	a5,506(a4) # 908 <freep>
}
 716:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 744:	1c853503          	ld	a0,456(a0) # 908 <freep>
 ...
 76c:	1a090913          	addi	s2,s2,416 # 908 <freep>
  if(p == (char*)-1)
 770:	5afd                	li	s5,-1
 772:	a88d                	j	7e4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 774:	00000797          	auipc	a5,0x0
 778:	19c78793          	addi	a5,a5,412 # 910 <base>
 77c:	00000717          	auipc	a4,0x0
 780:	18f73623          	sd	a5,396(a4) # 908 <freep>
 784:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a6:	16a73323          	sd	a0,358(a4) # 908 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 81a:	0ca50513          	addi	a0,a0,202 # 8e0 <digits+0x18>
 ...
 86e:	08658593          	addi	a1,a1,134 # 8f0 <digits+0x28>
 872:	4509                	li	a0,2
