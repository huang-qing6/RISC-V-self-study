...
fmtname(char *path)
{
  ...
  6a:	b4298993          	addi	s3,s3,-1214 # ba8 <buf.0>
...
ls(char *path)
{
 ...
 128:	9f450513          	addi	a0,a0,-1548 # b18 <statistics+0xbc>
 ...
 166:	98658593          	addi	a1,a1,-1658 # ae8 <statistics+0x8c>
 16a:	4509                	li	a0,2
 ...
 17c:	98858593          	addi	a1,a1,-1656 # b00 <statistics+0xa4>
 180:	4509                	li	a0,2
 ...
 1ae:	97e50513          	addi	a0,a0,-1666 # b28 <statistics+0xcc>
 ...
 1f4:	950a0a13          	addi	s4,s4,-1712 # b40 <statistics+0xe4>
        printf("ls: cannot stat %s\n", buf);
 1f8:	00001a97          	auipc	s5,0x1
 1fc:	908a8a93          	addi	s5,s5,-1784 # b00 <statistics+0xa4>
...
main(int argc, char *argv[])
{
 ...
 2be:	89650513          	addi	a0,a0,-1898 # b50 <statistics+0xf4>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 836:	32690913          	addi	s2,s2,806 # b58 <statistics+0xfc>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8fe:	2a67b783          	ld	a5,678(a5) # ba0 <freep>
 ...
 92c:	00e6ea63          	bltu	a3,a4,940 <free+0x50>
{
 ...
 96e:	22f73b23          	sd	a5,566(a4) # ba0 <freep>
}
 972:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9a0:	20453503          	ld	a0,516(a0) # ba0 <freep>
 ...
 9c8:	1dc90913          	addi	s2,s2,476 # ba0 <freep>
  if(p == (char*)-1)
 9cc:	5afd                	li	s5,-1
 9ce:	a88d                	j	a40 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9d0:	00000797          	auipc	a5,0x0
 9d4:	1e878793          	addi	a5,a5,488 # bb8 <base>
 9d8:	00000717          	auipc	a4,0x0
 9dc:	1cf73423          	sd	a5,456(a4) # ba0 <freep>
 9e0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a02:	1aa73123          	sd	a0,418(a4) # ba0 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 a76:	10650513          	addi	a0,a0,262 # b78 <digits+0x18>
 a7a:	00000097          	auipc	ra,0x0
 a7e:	b08080e7          	jalr	-1272(ra) # 582 <open>
  if(fd < 0) {
 a82:	04054263          	bltz	a0,ac6 <statistics+0x6a>
 a86:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 a88:	4481                	li	s1,0
 a8a:	03205063          	blez	s2,aaa <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 a8e:	4099063b          	subw	a2,s2,s1
 a92:	009a05b3          	add	a1,s4,s1
 a96:	854e                	mv	a0,s3
 a98:	00000097          	auipc	ra,0x0
 a9c:	ac2080e7          	jalr	-1342(ra) # 55a <read>
 aa0:	00054563          	bltz	a0,aaa <statistics+0x4e>
      break;
    }
    i += n;
 aa4:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 aa6:	ff24c4e3          	blt	s1,s2,a8e <statistics+0x32>
  }
  close(fd);
 aaa:	854e                	mv	a0,s3
 aac:	00000097          	auipc	ra,0x0
 ab0:	abe080e7          	jalr	-1346(ra) # 56a <close>
  return i;
}
 ab4:	8526                	mv	a0,s1
 ...
 aca:	0c258593          	addi	a1,a1,194 # b88 <digits+0x28>
 ace:	4509                	li	a0,2
 ad0:	00000097          	auipc	ra,0x0
 ad4:	dbc080e7          	jalr	-580(ra) # 88c <fprintf>
      exit(1);
 ad8:	4505                	li	a0,1
 ada:	00000097          	auipc	ra,0x0
 ade:	a68080e7          	jalr	-1432(ra) # 542 <exit>
