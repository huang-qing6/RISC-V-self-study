...
main(int argc, char *argv[])
{
  ...
  14:	86058593          	addi	a1,a1,-1952 # 870 <statistics+0x88>
  18:	4509                	li	a0,2
  ...
  50:	83c58593          	addi	a1,a1,-1988 # 888 <statistics+0xa0>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b6:	4f650513          	addi	a0,a0,1270 # 8a8 <digits>
 3ba:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 482:	42ab8b93          	addi	s7,s7,1066 # 8a8 <digits>
 ...
 5c2:	2e290913          	addi	s2,s2,738 # 8a0 <statistics+0xb8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 68a:	2627b783          	ld	a5,610(a5) # 8e8 <freep>
 ...
 6b8:	00e6ea63          	bltu	a3,a4,6cc <free+0x50>
{
 ...
 6fa:	1ef73923          	sd	a5,498(a4) # 8e8 <freep>
}
 6fe:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 72c:	1c053503          	ld	a0,448(a0) # 8e8 <freep>
 ...
 754:	19890913          	addi	s2,s2,408 # 8e8 <freep>
  if(p == (char*)-1)
 758:	5afd                	li	s5,-1
 75a:	a88d                	j	7cc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 75c:	00000797          	auipc	a5,0x0
 760:	19478793          	addi	a5,a5,404 # 8f0 <base>
 764:	00000717          	auipc	a4,0x0
 768:	18f73223          	sd	a5,388(a4) # 8e8 <freep>
 76c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 78e:	14a73f23          	sd	a0,350(a4) # 8e8 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 802:	0c250513          	addi	a0,a0,194 # 8c0 <digits+0x18>
 806:	00000097          	auipc	ra,0x0
 80a:	b08080e7          	jalr	-1272(ra) # 30e <open>
  if(fd < 0) {
 ...
 828:	ac2080e7          	jalr	-1342(ra) # 2e6 <read>
 ...
 83c:	abe080e7          	jalr	-1346(ra) # 2f6 <close>
  return i;
}
 840:	8526                	mv	a0,s1
 ...
 856:	07e58593          	addi	a1,a1,126 # 8d0 <digits+0x28>
 85a:	4509                	li	a0,2
 85c:	00000097          	auipc	ra,0x0
 860:	dbc080e7          	jalr	-580(ra) # 618 <fprintf>
      exit(1);
 864:	4505                	li	a0,1
 866:	00000097          	auipc	ra,0x0
 86a:	a68080e7          	jalr	-1432(ra) # 2ce <exit>
