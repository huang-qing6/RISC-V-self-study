...
main(int argc, char *argv[])
{
  ...
  2e:	86ea0a13          	addi	s4,s4,-1938 # 898 <statistics+0x8c>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	83858593          	addi	a1,a1,-1992 # 8a0 <statistics+0x94>
  70:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5e6:	2c690913          	addi	s2,s2,710 # 8a8 <statistics+0x9c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ae:	2467b783          	ld	a5,582(a5) # 8f0 <freep>
 ...
 6dc:	00e6ea63          	bltu	a3,a4,6f0 <free+0x50>
{
 ...
 71e:	1cf73b23          	sd	a5,470(a4) # 8f0 <freep>
}
 722:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 750:	1a453503          	ld	a0,420(a0) # 8f0 <freep>
 ...
 778:	17c90913          	addi	s2,s2,380 # 8f0 <freep>
  if(p == (char*)-1)
 77c:	5afd                	li	s5,-1
 77e:	a88d                	j	7f0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 780:	00000797          	auipc	a5,0x0
 784:	17878793          	addi	a5,a5,376 # 8f8 <base>
 788:	00000717          	auipc	a4,0x0
 78c:	16f73423          	sd	a5,360(a4) # 8f0 <freep>
 790:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b2:	14a73123          	sd	a0,322(a4) # 8f0 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 812:	ec26                	sd	s1,24(sp)
 814:	e84a                	sd	s2,16(sp)
 816:	e44e                	sd	s3,8(sp)
 818:	e052                	sd	s4,0(sp)
 ...
 826:	0a650513          	addi	a0,a0,166 # 8c8 <digits+0x18>
 82a:	00000097          	auipc	ra,0x0
 82e:	b08080e7          	jalr	-1272(ra) # 332 <open>
  if(fd < 0) {
 832:	04054263          	bltz	a0,876 <statistics+0x6a>
 836:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 838:	4481                	li	s1,0
 83a:	03205063          	blez	s2,85a <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 83e:	4099063b          	subw	a2,s2,s1
 842:	009a05b3          	add	a1,s4,s1
 846:	854e                	mv	a0,s3
 848:	00000097          	auipc	ra,0x0
 84c:	ac2080e7          	jalr	-1342(ra) # 30a <read>
 850:	00054563          	bltz	a0,85a <statistics+0x4e>
      break;
    }
    i += n;
 854:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 856:	ff24c4e3          	blt	s1,s2,83e <statistics+0x32>
  }
  close(fd);
 85a:	854e                	mv	a0,s3
 85c:	00000097          	auipc	ra,0x0
 860:	abe080e7          	jalr	-1346(ra) # 31a <close>
  return i;
}
 864:	8526                	mv	a0,s1
 ...
 874:	8082                	ret
      fprintf(2, "stats: open failed\n");
 876:	00000597          	auipc	a1,0x0
 87a:	06258593          	addi	a1,a1,98 # 8d8 <digits+0x28>
 87e:	4509                	li	a0,2
 880:	00000097          	auipc	ra,0x0
 884:	dbc080e7          	jalr	-580(ra) # 63c <fprintf>
      exit(1);
 888:	4505                	li	a0,1
 88a:	00000097          	auipc	ra,0x0
 88e:	a68080e7          	jalr	-1432(ra) # 2f2 <exit>
