...
cat(int fd)
{
  ...
  44:	8f058593          	addi	a1,a1,-1808 # 930 <statistics+0x8a>
  48:	4509                	li	a0,2
  ...
  72:	8da58593          	addi	a1,a1,-1830 # 948 <statistics+0xa2>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	85e58593          	addi	a1,a1,-1954 # 960 <statistics+0xba>
 10a:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 680:	2fc90913          	addi	s2,s2,764 # 978 <statistics+0xd2>
        while(*s != 0){
...
free(void *ap)
{
 ...
 748:	27c7b783          	ld	a5,636(a5) # 9c0 <freep>
...
malloc(uint nbytes)
{
 ...
 7ea:	1da53503          	ld	a0,474(a0) # 9c0 <freep>
 ...
 81e:	3ae78793          	addi	a5,a5,942 # bc8 <base>
 822:	00000717          	auipc	a4,0x0
 826:	18f73f23          	sd	a5,414(a4) # 9c0 <freep>
 82a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 84c:	16a73c23          	sd	a0,376(a4) # 9c0 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8c0:	0dc50513          	addi	a0,a0,220 # 998 <digits+0x18>
 8c4:	00000097          	auipc	ra,0x0
 8c8:	b08080e7          	jalr	-1272(ra) # 3cc <open>
  if(fd < 0) {
 8cc:	04054263          	bltz	a0,910 <statistics+0x6a>
 8d0:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 8d2:	4481                	li	s1,0
 8d4:	03205063          	blez	s2,8f4 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 8d8:	4099063b          	subw	a2,s2,s1
 8dc:	009a05b3          	add	a1,s4,s1
 8e0:	854e                	mv	a0,s3
 8e2:	00000097          	auipc	ra,0x0
 8e6:	ac2080e7          	jalr	-1342(ra) # 3a4 <read>
 8ea:	00054563          	bltz	a0,8f4 <statistics+0x4e>
      break;
    }
    i += n;
 8ee:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 8f0:	ff24c4e3          	blt	s1,s2,8d8 <statistics+0x32>
  }
  close(fd);
 8f4:	854e                	mv	a0,s3
 8f6:	00000097          	auipc	ra,0x0
 8fa:	abe080e7          	jalr	-1346(ra) # 3b4 <close>
  return i;
}
 8fe:	8526                	mv	a0,s1
 ...
 914:	09858593          	addi	a1,a1,152 # 9a8 <digits+0x28>
 918:	4509                	li	a0,2
 91a:	00000097          	auipc	ra,0x0
 91e:	dbc080e7          	jalr	-580(ra) # 6d6 <fprintf>
      exit(1);
 922:	4505                	li	a0,1
 924:	00000097          	auipc	ra,0x0
 928:	a68080e7          	jalr	-1432(ra) # 38c <exit>
